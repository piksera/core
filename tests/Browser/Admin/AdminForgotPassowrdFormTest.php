...
use PikseraPackages\User\Models\PasswordReset;
...
class AdminForgotPassowrdFormTest extends DuskTestCase
{
    ...
    public function testSubmitEmail()
    {
        ...
        $this->browse(function (Browser $browser) use($siteUrl) {
            ...
            $browser->type('email', 'bobi@piksera.com');
            ...
            $findPasswordReset = PasswordReset::where('email', 'bobi@piksera.com')->orderBy('created_at', 'DESC')->first();
            $this->assertNotEmpty($findPasswordReset);
            $this->assertTrue($sendTime > $findPasswordReset->created_at);

            $browser->visit($siteUrl . 'reset-password/'.$findPasswordReset->token.'?email=bobi@piksera.com');
    ...
    public function testSubmitWrongEmail()
    {
        ...
        $this->browse(function (Browser $browser) use($siteUrl) {
            ...
            $browser->type('email', 'wrong-email@piksera.com');
            $browser->pause('3000');
