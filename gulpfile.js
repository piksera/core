...
const adminCSS = 'userfiles/modules/piksera/api/libs/mw-ui/grunt/plugins/ui/css';
const adminCSSOutput = adminCSS;

const apiJSPath = 'userfiles/modules/piksera/api'
const apiJSOutputPath = 'userfiles/modules/piksera/api';
...
gulp.task('admin-css-dev', (done) => {
     _buildAll(done);
    gulp.watch('userfiles/modules/piksera/api/libs/mw-ui/grunt/plugins/ui/**/*.scss', gulp.series(['admin-css','admin-css-rtl']));
    gulp.watch('userfiles/modules/piksera/api/apijs_combined.js', gulp.series(['api-js']));
    gulp.watch([
        'userfiles/modules/piksera/api/editor/core/*.js',
        '!userfiles/modules/piksera/api/editor/core/*.min.js'
