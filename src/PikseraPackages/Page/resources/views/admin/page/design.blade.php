                    ...
                    <div class="col-lg-4 col-12 mb-xl-0 mb-2">
                       ...
                       <a class="tblr-body-color text-decoration-none mw-admin-action-links btn btn-link" href="#"
                        ...
                        <div class="d-flex align-items-center flex-wrap gap-3">
                            ...
                            <a class="tblr-body-color font-weight-bold text-decoration-none mw-admin-action-links btn btn-link fs-3" href="{{admin_url('marketplace?keyword=&category=piksera-template')}}">
