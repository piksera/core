...
abstract class TestCase extends \Illuminate\Foundation\Testing\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $mw_file = $config_folder . '/piksera.php';
        if (!is_file($mw_file)) {
            $this->install();
        }
    ...
    public function install()
    {
        ...
        if ($test_env_from_conf) {
            ...
            if (!defined('PS_UNIT_TEST_ENV_FROM_TEST')) {
                define('PS_UNIT_TEST_ENV_FROM_TEST', $testing_env_name);
                $config_folder = __DIR__ . '/../../../../config/';
                $config_folder = realpath($config_folder);
                $mw_file = $config_folder . '/piksera.php';
            }
        ...
        if (!defined('PS_UNIT_TEST_CONF_FILE_CREATED')) {
        ...
        if (!defined('PS_UNIT_TEST_CONF_FILE_CREATED')) {
            ...
            define('PS_UNIT_TEST_CONF_FILE_CREATED', true);
            ...
            if (!defined('PS_UNIT_TEST_DB_CLEANED')) {
                if (is_file($this->sqlite_file)) {
                    @unlink($this->sqlite_file);
                }
                define('PS_UNIT_TEST_DB_CLEANED', true);
            ...
            $install = \Artisan::call('piksera:install', $install_params);
