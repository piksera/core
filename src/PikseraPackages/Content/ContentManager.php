...
class ContentManager
{
    ...
    public function __construct($app = null)
    {
        ...
        //$this->content_repository = $this->app->repository_manager->driver(\PikseraPackages\Content\Content::class);
    ...
    return  \PikseraPackages\Content\Facades\ContentManager::getById($id);
...
//            }
     ...
     * </code>
     *
     * @constant  PS_LANG defines the PS_LANG constant
     */
//    public function lang_current()
//    {
//        if (defined('PS_LANG') and PS_LANG != false) {
//            return PS_LANG;
//        }
//
//        $lang = false;
...
//        if (!defined('PS_LANG') and isset($lang)) {
//            define('PS_LANG', $lang);
//        }
//
//        return $lang;
...
// ------------------------------------------------------------------------
    ...
    public function save_content_admin($data, $delete_the_cache = true)
    {
        ...
        if ($adm == false) {
            ...
            if ($stop == true) {
                if (defined('PS_API_FUNCTION_CALL') and PS_API_FUNCTION_CALL == __FUNCTION__) {
    ...
    public function next_content($content_id = false, $mode = 'next', $content_type = false)
    {
        ...
        $query = \PikseraPackages\Content\Models\Content::query()->select('content.*');
        $categories = array();
        $params = array();
