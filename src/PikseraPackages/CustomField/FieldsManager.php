...
namespace PikseraPackages\CustomField;

use PikseraPackages\CustomField\Fields\Breakline;
use PikseraPackages\CustomField\Fields\Button;
use PikseraPackages\CustomField\Fields\Checkbox;
use PikseraPackages\CustomField\Fields\Color;
use PikseraPackages\CustomField\Fields\Country;
use PikseraPackages\CustomField\Fields\Date;
use PikseraPackages\CustomField\Fields\DefaultField;
use PikseraPackages\CustomField\Fields\Dropdown;
use PikseraPackages\CustomField\Fields\Email;
use PikseraPackages\CustomField\Fields\Hidden;
use PikseraPackages\CustomField\Fields\Number;
use PikseraPackages\CustomField\Fields\Password;
use PikseraPackages\CustomField\Fields\Phone;
use PikseraPackages\CustomField\Fields\Price;
use PikseraPackages\CustomField\Fields\Property;
use PikseraPackages\CustomField\Fields\Radio;
use PikseraPackages\CustomField\Fields\Site;
use PikseraPackages\CustomField\Fields\Text;
use PikseraPackages\CustomField\Fields\TextArea;
use PikseraPackages\CustomField\Fields\Time;
use PikseraPackages\Helper\HTMLClean;
use PikseraPackages\Helper\XSSSecurity;
use function Matrix\trace;
use PikseraPackages\CustomField\Events\CustomFieldWasDeleted;
use PikseraPackages\CustomField\Fields\Address;
use PikseraPackages\CustomField\Models\CustomField;
use PikseraPackages\CustomField\Models\CustomFieldValue;
...
//        }
    ...
    public function delete($id)
    {
        ...
        if (defined('PS_API_CALL') and $uid == false) {
    ...
    public function instanceField($type)
    {
        ...
        $fieldClass = $typeToClassMap[$type] ?? 'PikseraPackages\\CustomField\\Fields\\' . ucfirst($type);
