<div>
    ...
    <div class="row">
        <div class="col-md-4 h-auto" style="background:#ececec;">
            ...
            <div class="mt-3 ms-2">
                <x-piksera-ui::input wire:model="search" type="text" placeholder="Search fonts..." />
            </div>
            ...
            <div class="d-flex flex-column align-items-start gap-2 mt-3 ms-3">
                ...
                <x-piksera-ui::button-animation :class="$buttonClass" wire:click="category('{{$categoryKey}}')">
                    {{ $categoryName }}
...
<!--                    Don't change the high of handle. Cause you will break the draggable modal.-->
            ...
            <div class="pr-5">
                ...
                <div>
                    <div class="mt-3">
                        {!! $fonts->links('piksera-ui::livewire.pagination') !!}
                    </div>
                </div>
            </div>
        </div>
