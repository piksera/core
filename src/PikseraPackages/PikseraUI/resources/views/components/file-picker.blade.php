        ...
        <div id="js-preview-video-wrapper-{{$randId}}" style="display:none">
            <div>
                ...
                <div class="d-flex gap-2">
                    <x-piksera-ui::button-action type="button" class="btn-sm js-select-file-{{$randId}}">
                    ...
                    <x-piksera-ui::button-action type="button" class="js-remove-file-{{$randId}}">
        ...
        <div id="js-preview-image-wrapper-{{$randId}}" style="display:none">
            <div class="d-flex justify-content-between">
                ...
                <div class="d-flex gap-2">
                    ...
                    <x-piksera-ui::button-action type="button" id="js-edit-image-{{$randId}}" style="display:none" title="Edit">
