...
namespace PikseraPackages\Utils\Media\Adapters;
...
class Unsplash
{
    ...
    public function search($keyword, $page = 1) {
    	...
    	$json = mw()->http->url('http://imglib.pikseraapi.com/index.php?search='. $keyword . '&page=' . $page)->get();
    ...
    public function download($photoId) {
		...
		$imageUrl = 'http://imglib.pikseraapi.com/download.php?photo_id='. $photoId;
