...
namespace PikseraPackages\Utils\Captcha;

use PikseraPackages\Utils\Captcha\Adapters\GoogleRecaptchaV2;
use PikseraPackages\Utils\Captcha\Adapters\GoogleRecaptchaV3;
use PikseraPackages\Utils\Captcha\Adapters\PikseraCaptcha;
...
class CaptchaManager
{
    ...
    public function __construct($app = null)
    {
        ...
        if ($recaptcha_v2_secret_key and $captcha_provider == 'google_recaptcha_v2') {
            ...
            $this->adapter = new PikseraCaptcha($app);
        }
