           ...
           <div class="row">
               ...
               <div class="col-12">
                   <div class="d-flex justify-content-center gap-2">
                       <button type="button" id="js-packages-tab-template" class="btn @if($category == 'piksera-template') btn-dark @else btn-outline-dark @endif" wire:click="filterCategory('piksera-template')">
                       ...
                       <button type="button" id="js-packages-tab-module" class="btn @if($category == 'piksera-module') btn-dark @else btn-outline-dark @endif" wire:click="filterCategory('piksera-module')">
                                   ...
                                   <div class="card my-1 mx-1 card-sm card-link card-stacked">
                                       ...
                                       @if(isset($marketItem['extra']['_meta']['screenshot']))
                                           <button id="js-install-package-<?php echo $marketItem['target-dir']; ?>" type="button" class="border-0 d-block" onclick="Livewire.emit('openModal', 'admin-marketplace-item-modal', {{ json_encode(['name'=>$marketItem['name']]) }})">
                                               @if($marketItem['type'] == 'piksera-module')
