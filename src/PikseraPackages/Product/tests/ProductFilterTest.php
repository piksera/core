...
class ProductFilterTest extends TestCase
{
    ...
    public function testProductFilter()
    {
        ...
        $clean = \PikseraPackages\Product\Models\Product::truncate();
        ...
        $model = \PikseraPackages\Product\Models\Product::query();
    ...
    {
        $clean = \PikseraPackages\Cart\Models\Cart::truncate();
        $clean = \PikseraPackages\Order\Models\Order::truncate();
        ...
        $productQuery = \PikseraPackages\Product\Models\Product::query();
        $productQuery->filter([
            'orders'=>$count_orders
        ]);
