...
use PikseraPackages\Media\Models\MediaThumbnail;
use PikseraPackages\Utils\Media\Thumbnailer;
use PikseraPackages\Utils\System\Files;
...
//                        }
    ...
    public function relative_media_start_path()
    {
        ...
        if ($path == false) {
            ...
            $path = PS_MEDIA_FOLDER_NAME . '/' . $environment . '';
        }
