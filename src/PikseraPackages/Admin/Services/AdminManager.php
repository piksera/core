...
namespace PikseraPackages\Admin\Services;

use Illuminate\Support\Facades\Event;
use PikseraPackages\Admin\Events\ServingAdmin;
use PikseraPackages\Admin\MenuBuilder\Menu;
use PikseraPackages\Template\Traits\HasMenus;
use PikseraPackages\Template\Traits\HasScriptsAndStylesTrait;
    ...
    public function initMenus()
    {
        ...
        if($showServiceLink && $showPoweredBy) {
            ...
            $this->menus['left_menu_bottom']->addChild('Get Help', [
                'uri' => 'https://piksera.org/go/feedback/',
                'attributes' => [
                    'target' => '_blank',
