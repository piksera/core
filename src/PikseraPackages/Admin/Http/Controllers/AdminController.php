...
namespace PikseraPackages\Admin\Http\Controllers;
...
use Auth;
use PikseraPackages\App\Http\Middleware\AllowedIps;
...
class AdminController extends Controller
{
    ...
    public function webAppManifest()
    {
        ...
        if (!$maskable_icon) {
            $maskable_icon = modules_url() . 'piksera/api/libs/mw-ui/assets/img/logo-mobile.svg';
        }
        $manifest_app_icon = get_option('manifest_app_icon', 'website');
        if (!$manifest_app_icon) {
            $manifest_app_icon = modules_url() . 'piksera/api/libs/mw-ui/assets/img/logo-144x144.png';
        }
