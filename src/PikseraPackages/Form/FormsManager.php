...
namespace PikseraPackages\Form;
...
use PikseraPackages\Form\Models\FormRecipient;
use PikseraPackages\Form\Notifications\NewFormEntry;
use PikseraPackages\Form\Notifications\NewFormEntryAutoRespond;
use PikseraPackages\Form\Notifications\NewFormEntryToMail;
...
class FormsManager
{
    ...
    public function __construct($app = null)
    {
        ...
        if (!defined('PS_DB_TABLE_COUNTRIES')) {
            define('PS_DB_TABLE_COUNTRIES', 'countries');
        }
        if (!defined('PS_DB_TABLE_FORMS_LISTS')) {
            define('PS_DB_TABLE_FORMS_LISTS', 'forms_lists');
        }

        if (!defined('PS_DB_TABLE_FORMS_DATA')) {
            define('PS_DB_TABLE_FORMS_DATA', 'forms_data');
        }
    }
...
//            }
        ...
        // Save Atachments
        $files_utils = new \PikseraPackages\Utils\System\Files();
    ...
    {
        $countries_file = normalize_path(dirname(PS_PATH) . '/Utils/ThirdPartyLibs/country.json', false);
    ...
    public function countries_list($full = false)
    {
        ...
        if (empty($data)) {
            ...
            $countries_file = normalize_path(dirname(PS_PATH) . '/Utils/ThirdPartyLibs/country.csv', false);
