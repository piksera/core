...
namespace PikseraPackages\Category;

use DB;
use PikseraPackages\Category\HelperRenders\KnpCategoryTreeRenderer;
...
//    }
    ...
    {
        $tree = new \PikseraPackages\Category\AdminJsCategoryTree();
        $tree->filters($params);
