...
namespace PikseraPackages\Repository\Repositories;
...
use PikseraPackages\Repository\Traits\CacheableRepository;
    ...
    /*  public function getByParams($params = [])
      {
         return $this->cacheCallback(get_class($this).__FUNCTION__, func_get_args(), function () use ($params) {
             $this->newQuery();
             return PikseraQuery::execute($this->query, $params);
          });
      }*/
