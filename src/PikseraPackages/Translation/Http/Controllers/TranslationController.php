...
namespace PikseraPackages\Translation\Http\Controllers;

use Illuminate\Http\Request;
use PikseraPackages\Import\Formats\XlsxReader;
use PikseraPackages\Export\Formats\JsonExport;
use PikseraPackages\Export\Formats\XlsxExport;
use PikseraPackages\Translation\Models\TranslationKey;
use PikseraPackages\Translation\Models\TranslationText;
use PikseraPackages\Translation\TranslationImport;
...
class TranslationController {
    ...
    public function save(Request $request) {
       ...
       \Config::set('piksera.disable_model_cache', true);
