<?php
namespace PikseraPackages\FileManager\Http\Controllers\Api;
...
class FileManagerApiController extends Controller {
    ...
    public function list(Request $request) {
        ...
        $data = [];
        $getData = app()->make(\PikseraPackages\Utils\System\Files::class)->get($fileFilter);
                ...
                if (isset($fnRemove) and trim($fnRemove) != '' and trim($fnRemove) != 'false') {
                    ...
                    if (stristr($targetPath, media_uploads_path())) {
                        if (is_dir($targetPath)) {
                            mw('PikseraPackages\Utils\System\Files')->rmdir($targetPath, false);
