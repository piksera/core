...
api_expose_admin('media_library/search', function ($data) {
    ...
    $search = array();
    $unsplash = new \PikseraPackages\Utils\Media\Adapters\Unsplash();
...
api_expose('queue_dispatch1', function () {
    ...
    $job = Queue::push('\PikseraPackages\Utils\Import', ['export' => '']);
    ...
    $job = mw('\PikseraPackages\Utils\Import', ['export' => '']);
    dispatch($job)->onQueue('high');
