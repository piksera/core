    ...
    function lang($title, $namespace = false)
    {
        ...
        if (isset($mw_language_content_file[$k1]) == false) {
            ...
            if (!$namespace) {
                ...
                if (!defined('PS_LANG_STORE_ON_EXIT_EVENT_BINDED')) {
                    define('PS_LANG_STORE_ON_EXIT_EVENT_BINDED', 1);
                    $scheduler = new Event();
                ...
                if (!isset($mw_new_language_entries_ns[$namespace][$k1])) {
                    ...
                    if (!defined('PS_LANG_STORE_ON_EXIT_EVENT_BINDED_NS')) {
                        define('PS_LANG_STORE_ON_EXIT_EVENT_BINDED_NS', 1);
                        $scheduler = new Event();
                        if ($environment != 'testing') {
