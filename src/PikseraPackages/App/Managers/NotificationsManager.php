...
use PikseraPackages\Notification\Models\Notification;
use PikseraPackages\Notification\Notifications\LegacyNotification;
...
class NotificationsManager
{
    ...
    public function mark_all_as_read($params = false)
    {
        return [];
        $is_admin = $this->app->user_manager->is_admin();
        if (defined('PS_API_CALL') and $is_admin == false) {
            return array('error' => 'You must be logged in as admin to perform: ' . __CLASS__ . '->' . __FUNCTION__);
        }
