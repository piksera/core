...
namespace PikseraPackages\App\Utils\Adapters\Cache;
...
{
    /** @var \PikseraPackages\Utils\Adapters\Cache\Storage\FileStorage */
    public $adapter;
    ...
    public function __construct($prefix = '')
    {
        ...
        $adapter_from_config = \Config::get('piksera.cache_adapter');
        $use_file_cache = true;
