...
class FrontendController extends Controller
{
    ...
    public function index($request_params = [])
    {
        ...
        if (\Config::get('piksera.force_https') && !is_cli() && !is_https()) {
    ...
    public function frontend($request_params = [])
    {
        ...
        // moved to src/PikseraPackages/MetaTags/Entities/FaviconHeadTag.php
//        $favicon_image = false;
//
...
//
        ...
        // moved to src/PikseraPackages/MetaTags/Entities/FrontendAnimationsScriptTag.php
...
// moved to src/PikseraPackages/MetaTags/Entities/CustomHeadTagsFromCallback.php
...
// moved to src/PikseraPackages/MetaTags/Entities/WebmasterHeadTags.php
...
//                }
                ...
                // @todo remove this and fix src/PikseraPackages/MetaTags/Entities/LivewireHeadTags.php
         ...
         /*   if (isset($content['active_site_template']) and trim($content['active_site_template']) != '' and $content['active_site_template'] != 'default') {
            ...
            // moved to src/PikseraPackages/MetaTags/Entities/LiveEditCssHeadTags.php
...
// moved to src/PikseraPackages/MetaTags/Entities/CustomFontsCssHeadTags.php
...
//            }
            ...
            //src/PikseraPackages/MetaTags/Entities/CustomCssHeadTags.php
...
//            }
            ...
            // moved to src/PikseraPackages/MetaTags/Entities/CustomUserHeadTags.php
