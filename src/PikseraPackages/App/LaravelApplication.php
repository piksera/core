...
use PikseraPackages\Cache\TaggableFileCacheServiceProvider;
...
class LaravelApplication extends Application
{
    ...
    public function getCachedPikseraServiceProvidersPath()
    {

        return $this->normalizeCachePath('APP_PS_SERVICE_PROVIDERS_CACHE', 'cache/mw_loaded_providers.' . self::VERSION . '_' . self::APP_VERSION . '.php');
    }
