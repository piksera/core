    ...
    <div class="card mb-4 shadow rounded-0">
        <div class="card-header d-block">
            <div class="text-center my-3">
                ...
                <?php else: ?>
                    <a href="http://Piksera.com" target="_blank" id="logo"><img src="<?php print mw_includes_url(); ?>api/libs/mw-ui/assets/img/logo.svg" style="width: 250px" /></a>
                <?php endif; ?>
            </div>
                ...
                <div class="description">
                    ...
                    <div class="mw-install-holder">
                        <?php if ($done == false): ?>
                            ...
                            if (defined('PS_USERFILES') and is_dir(PS_USERFILES) and !is_writable(PS_USERFILES)) {
                                $check_pass = false;
                                $must_be = PS_USERFILES;
                                $server_check_errors['PS_USERFILES'] = _e('The directory ' . PS_USERFILES . ' must be writable', true);
                            }
                            ...
                            <?php if ($check_pass == false): ?>
                                <?php if (!empty($server_check_errors)): ?>
                                    ...
                                    <h6 class="font-weight"><?php _e('There are some errors on your server that will prevent Piksera from working properly'); ?></h6>
                                    <ol class="error">
