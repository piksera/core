...
namespace PikseraPackages\Piksera\Providers;
...
use PikseraPackages\PikseraUI\Providers\PikseraUIServiceProvider;
...
class PikseraServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
         ...
         */
        $this->app->singleton('piksera', function () {
            return new Piksera();
        });
    ...
    public function registerInternalProviders(): void
    {
        ...
        $this->app->register(PikseraUIServiceProvider::class);
