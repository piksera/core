...
use PikseraPackages\Notification\Channels\AppMailChannel;
use PikseraPackages\Notification\Mail\SimpleHtmlEmail;
...
use PikseraPackages\User\Notifications\VerifyEmail;
use PikseraPackages\User\tests\UserTestHelperTrait;
...
class UserManagerTest extends TestCase
{
    ...
    public function testRegistration()
    {
        ...
        $newUser['email'] = $newUser['username'] . '@piksera.com';
    ...
    */
    ...
    public function testWrongPasswordLogin()
    {
        ...
        $loginDetails = array();
        $loginDetails['username'] = self::$_username;
        $loginDetails['password'] = 'piksera-best';
    ...
    public function testWrongUsernameLogin()
    {
        ...
        $loginDetails = array();
        $loginDetails['username'] = 'piksera-some-user';
        $loginDetails['password'] = 'piksera-some-pass';
    ...
    public function testWrongEmailLogin()
    {
        ...
        $loginDetails = array();
        $loginDetails['email'] = 'piksera-some-email';
        $loginDetails['password'] = 'piksera-some-pass';
