<?php
namespace PikseraPackages\User\Socialite;
...
class PikseraProvider extends AbstractProvider implements ProviderInterface
{
    ...
    protected function apiUrl($path)
    {
        ...
        if (!empty($piksera_app_url)) {
            $this->serverUrl = $piksera_app_url;
        }
    ...
    protected function getUserByToken($token)
    {
        ...
        $response = $this->getHttpClient()->get($this->apiUrl('/api/user'), [
            ...
            'verify' => PS_PATH . 'Utils' . DS . 'Adapters' . DS . 'Http' . DS . 'cacert.pem.txt'
        ]);
