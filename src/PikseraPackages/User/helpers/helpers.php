...
function module_permissions($module)
{
    ...
    return \PikseraPackages\Role\Repositories\Permission::generateModulePermissionsSlugs($module);
}

function user_can_destroy_module($module)
{
    //   $permissions = \PikseraPackages\Role\Repositories\Permission::generateModulePermissionsSlugs($module);
    ...
    if (!empty($params)) {
        if (isset($params['username']) || isset($params['email'])) {
            ...
            if (isset($params['username'])) {
                $findByUsername = \PikseraPackages\User\Models\User::where('username', $params['username'])->first();
            }
            ...
            if ($findByUsername) {
                ...
                if (isset($params['email'])) {
                    $findByEmail = \PikseraPackages\User\Models\User::where('email', $params['email'])->first();
                    if ($findByEmail) {
