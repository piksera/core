...
use PikseraPackages\Utils\Zip\ZipArchiveExtractor;
...
class ZipReader extends DefaultReader
{
	...
	public function readData()
	{
        ...
        if (!is_dir($backupLocation)) {
            ...
            if (config('piksera.allow_php_files_upload')) {
		...
		foreach ($filesForImporting as $file) {
			...
			$readerClass = 'PikseraPackages\\Import\\Formats\\' . ucfirst($file['reader']) . 'Reader';
