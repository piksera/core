...
class PikseraModuleTagCompiler extends ComponentTagCompiler
{
    public function compile($value)
    {

        return $this->compilePikseraModuleSelfClosingTags($value);
    }

    protected function compilePikseraModuleSelfClosingTags($value)
    {
    ...
    private function extractModuleTagAttributes($module_tag)
    {
        ...
        $mw_attrs_key_value_seperator = "__PS_PARSER_ATTR_VAL__";
