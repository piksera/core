...
namespace PikseraPackages\Template\Adapters;

use PikseraPackages\Template\Adapters\RenderHelpers\TemplateMetaTagsPlaceholderReplacer;
use PikseraPackages\Template\Http\Livewire\Admin\StyleSettingsFirstLevelConvertor;
use PikseraPackages\View\View;

class PikseraTemplate
{
...
//        }
    ...
    public function defineConstants($content = false)
    {
        ...
        if ($content == false) {
            ...
            } else if (!defined('PS_BACKEND') and (is_ajax() or defined('PS_API_CALL')) && isset($_SERVER['HTTP_REFERER'])) {
