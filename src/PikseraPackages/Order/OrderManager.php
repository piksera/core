...
namespace PikseraPackages\Order;
...
use PikseraPackages\Product\Notifications\ProductOutOfStockNotification;
...
class OrderManager
{
    ...
    public function get($params = false)
    {
        ...
        if (defined('PS_API_CALL') and $this->app->user_manager->is_admin() == false) {
    ...
    public function delete_order($data)
    {
        ...
        if (defined('PS_API_CALL') and $adm == false) {
