...
showEditTab: 'main'
        ...
        var event = new Event('moduleSettings.showConfirmDeleteItemById',  { detail: itemId });
                ...
                <div style="overflow: hidden">
                        ...
                        <div class="row row-cards">
                            <div class="col-12">
                                <div class="card shadow-none">
                                    ...
                                    <div class="mt-2">
                                        <x-piksera-ui::button-animation type="button" class="mt-2"
                    ...
                    <div x-show="showEditTab=='tabs-nav-tab-new-item'"
                        ...
                        <div id="add-new-item-holder">
                            <livewire:piksera-live-edit::module-items-editor-edit-item
            ...
            @else
                ...
                <div class="alert-info">
                    ...
                    <div id="add-new-item-holder">
                        <livewire:piksera-live-edit::module-items-editor-edit-item wire:key="newItem{{$moduleId}}"
                                                                                      :moduleId="$moduleId"
                                                                                      :moduleType="$moduleType"
                                                                                      :editorSettings="$editorSettings"/>
    ...
    <div>
        <x-piksera-ui::dialog-modal wire:key="areYouSureDeleteModalOpened" wire:model="areYouSureDeleteModalOpened">
