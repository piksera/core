...
<head>
    ...
    @vite('src/PikseraPackages/LiveEdit/resources/js/ui/live-edit-app.js')
...
<script>
    ...
    window.addEventListener('load', function () {
        if(mw.top() && mw.top().app && mw.top().app.liveEdit && mw.top().app.fontManager){
            mw.top().app.fontManager.addFonts({!! json_encode(\PikseraPackages\Utils\Misc\GoogleFonts::getEnabledFonts()) !!});
        }
