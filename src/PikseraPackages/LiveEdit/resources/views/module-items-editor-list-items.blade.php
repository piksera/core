                            ...
                            <div class="list-group-item js-sortable-item p-2" sort-key="{{ $itemId }}"
                                ...
                                <div class="row align-items-center"  id="item-list-row-{{ $itemId }}">
                                        ...
                                        <div class="col text-truncate"
                                            ...
                                            @foreach ($editorSettings['config']['listColumns'] as $columnKey => $columnLabel)
                                                @if (isset($item[$columnKey]))
                                                    ...
                                                    @if (\PikseraPackages\Media\MediaManager::guessMediaTypeFromUrl($item[$columnKey]) == 'picture')
                                    ...
                                    <div class="col-auto d-flex align-items-center">
                                        ...
                                        <x-piksera-ui::button-action  wire:key="item-list-delete-btn-{{ $itemId  }}" type="button" :tooltip="$deleteButtonText"
                                                                         wire:click="$emit('onShowConfirmDeleteItemById', '{{ $itemId }}')">
                                                <?php print $deleteButtonIconSvg ?>
                                        </x-piksera-ui::button-action>

                                        <x-piksera-ui::button-action wire:key="item-list-edit-btn-{{ $itemId  }}" type="button" wire:click="$emit('editItemById', '{{ $itemId }}')">
