<div>
    ...
    $showSkinsDropdown = true;
        ...
        $componentNameForModuleSkin = 'piksera-module-'.$moduleType.'::template-settings-'.$currentSkinName;

        $moduleSkinSettingsRegisteredAlias =  \PikseraPackages\Module\Facades\ModuleAdmin::getSkinSettings($moduleType, $currentSkinName);
    ...
    <div class="mw-module-select-template"
        ...
        <div class="mt-4 mb-3">
            ...
            @endphp
            <x-piksera-ui::select-modern wire:model="settings.template" :options="$selectModernOptions" />
        </div>
