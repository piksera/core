...
use PikseraPackages\LiveEdit\Facades\LiveEditManager as LiveEditManagerFacade;
use PikseraPackages\LiveEdit\Http\Livewire\ItemsEditor\ModuleSettingsItemsEditorComponent;
use PikseraPackages\LiveEdit\Http\Livewire\ItemsEditor\ModuleSettingsItemsEditorEditItemComponent;
use PikseraPackages\LiveEdit\Http\Livewire\ItemsEditor\ModuleSettingsItemsEditorListComponent;
use PikseraPackages\LiveEdit\Http\Livewire\LiveEditSidebarAdmin\LiveEditSidebarAdminComponent;
use PikseraPackages\LiveEdit\Http\Livewire\LiveEditSidebarAdmin\LiveEditSidebarAdminModulesListComponent;
use PikseraPackages\LiveEdit\Http\Livewire\ModuleTemplateSelectComponent;
use PikseraPackages\LiveEdit\Http\Livewire\Presets\ModulePresetsManager;
use PikseraPackages\LiveEdit\Http\Middleware\DispatchServingLiveEdit;
use PikseraPackages\LiveEdit\Http\Middleware\DispatchServingModuleSettings;
...
class LiveEditServiceProvider extends PackageServiceProvider
{
    ...
    {
        $package->name('piksera-live-edit');
        $package->hasViews('piksera-live-edit');
    ...
    {
        parent::register();
        View::addNamespace('piksera-live-edit', __DIR__ . '/resources/views');

        \App::singleton('LiveEditManager', function () {
            return new LiveEditManager();
        });

        Livewire::component('piksera-live-edit::module-select-template', ModuleTemplateSelectComponent::class);
        Livewire::component('piksera-live-edit::module-items-editor', ModuleSettingsItemsEditorComponent::class);
        Livewire::component('piksera-live-edit::module-items-editor-list', ModuleSettingsItemsEditorListComponent::class);
        Livewire::component('piksera-live-edit::module-items-editor-edit-item', ModuleSettingsItemsEditorEditItemComponent::class);
        Livewire::component('piksera-live-edit::sidebar-admin', LiveEditSidebarAdminComponent::class);
        Livewire::component('piksera-live-edit::sidebar-admin-modules-list', LiveEditSidebarAdminModulesListComponent::class);
        Livewire::component('piksera-live-edit::module-presets-manager', ModulePresetsManager::class);
    ...
    {
        \PikseraPackages\LiveEdit\Facades\LiveEditManager::getMenuInstance('top_right_menu')
