...
use PikseraPackages\Install\DbInstaller;
use PikseraPackages\Install\DefaultOptionsInstaller;
use PikseraPackages\Install\ModulesInstaller;
...
class ResetCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'piksera:reset {--only-content=}';
