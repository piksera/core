...
// php artisan piksera:module --module=shop --module_action=1 --env=localhost
// php artisan piksera:module --module=shop --module_action=0 --env=localhost

class ModuleCommand extends Command
{
    protected $name = 'piksera:module';
     ...
     * @var string
     */
    protected $signature = 'piksera:module {--module=} {--module_action=}';
