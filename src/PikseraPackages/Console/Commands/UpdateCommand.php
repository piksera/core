...
class UpdateCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'piksera:update {--branch=} {--confirm=}';


    public function handle()
    {

        if (!class_exists('PikseraPackages\Modules\StandaloneUpdater\StandaloneUpdaterServiceProvider', false)) {
        ...
        if (mw_is_installed()) {
            ...
            $contoller = new \PikseraPackages\Modules\StandaloneUpdater\Http\Controllers\StandaloneUpdaterController;
