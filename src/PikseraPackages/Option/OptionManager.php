...
namespace PikseraPackages\Option;
...
use PikseraPackages\Option\Traits\ModuleOptionTrait;
...
class OptionManager
{
    ...
    public function get_groups($is_system = false)
    {
        ...
        $query = new \PikseraPackages\Option\Models\Option();
