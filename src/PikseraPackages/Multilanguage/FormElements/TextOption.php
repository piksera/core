<?php
namespace PikseraPackages\Multilanguage\FormElements;

use PikseraPackages\Multilanguage\FormElements\Traits\JavascriptOptionChangerTrait;

class TextOption extends \PikseraPackages\FormBuilder\Elements\TextOption
{
 ...
 <input type="text" '.$this->renderAttributes().' id="js-multilanguage-text-' . $this->randId . '">
        ...
        foreach($supportedLanguages as $language) {
            ...
            $langData = \PikseraPackages\Translation\LanguageHelper::getLangData($language['locale']);
