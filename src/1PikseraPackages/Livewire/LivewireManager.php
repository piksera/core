...
class LivewireManager extends BaseLivewireManager
{
    ...
    {
        $livewireCacheFolder = base_path() . '/userfiles/cache/livewire/' . \PikseraPackages\App\LaravelApplication::APP_VERSION . '/livewire/';
    ...
    {
        $livewireCacheFolder = 'userfiles/cache/livewire/' . \PikseraPackages\App\LaravelApplication::APP_VERSION . '/livewire/livewire.js';
