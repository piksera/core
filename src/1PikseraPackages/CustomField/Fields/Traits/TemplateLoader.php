...
namespace PikseraPackages\CustomField\Fields\Traits;
...
trait TemplateLoader
{
    ...
    public function getTemplateFiles($data)
    {
        ...
        $settings_file = modules_path() . DS . 'piksera' . DS . 'custom_fields' . DS . $data['type'] . '_settings.php';
        if (!is_file($settings_file)) {
            $settings_file = modules_path() . DS . 'piksera' . DS . 'custom_fields' . DS . 'text_settings.php';
        }
