...
namespace PikseraPackages\Content\Http\Controllers\Requests;

use Illuminate\Contracts\Validation\Rule;
use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Validation\ValidationRuleParser;
use PikseraPackages\Content\Models\Content;
use PikseraPackages\Multilanguage\Http\Controllers\Requests\Rules\MultilanguageUniqueContentSlugRule;
                                ...
                                foreach ($supportedLocales as $supportedLocale) {
                                   if ($supportedLocale['locale'] != $defaultLocale) {
                                    ...
                                    if (is_string($fieldRule)) {
                                     ...
                                     //$fieldRuleExploded[] = (new \PikseraPackages\Multilanguage\Http\Controllers\Requests\Rules\MultilanguageUniqueContentSlugRule()) ;
