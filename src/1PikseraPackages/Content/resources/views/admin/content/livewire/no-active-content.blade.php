        ...
        <div class="no-items-found">
            ...
            <div class="row mt-lg-2">
                <div class="col-12 d-flex flex-wrap justify-content-center align-items-center text-center">
                    ...
                    <div class="col-lg-6 col-12 no-items-box order-lg-2 order-1" style="background-image: url('<?php print modules_url(); ?>piksera/api/libs/mw-ui/assets/img/no_posts.svg'); ">
