...
use PikseraPackages\Cache\CacheFileHandler\Facades\Cache;
use PikseraPackages\ComposerClient\Client;
use PikseraPackages\Utils\Zip\Unzip;

class PikseraComposerClient extends Client
{
    public $logfile;
    ...
    public function install($package)
    {
        ...
        $moduleName = str_replace('piksera-modules/', '', $moduleName);
        $moduleName = str_replace('piksera-templates/', '', $moduleName);
