...
namespace PikseraPackages\Utils\ThirdPartyLibs\PHPImageMagician;
...
## --------------------------------------------------------
    ...
    *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-**-*-*-*-*-*-*-*-*-*-*-*-*-*/
        ...
        #
    {
        ...
        // BITMAPFILEHEADER [14 bytes] - http://msdn.microsoft.com/library/en-us/gdi/bitmamw_62uq.asp
        ...
        // BITMAPINFOHEADER - [40 bytes] http://msdn.microsoft.com/library/en-us/gdi/bitmamw_1rw2.asp
