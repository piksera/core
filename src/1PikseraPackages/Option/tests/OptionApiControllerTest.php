    ...
    public function testSaveOptionWithModuleHtml()
    {
        ...
        $response = $this->call(
            ...
            [
                ...
                'option_value' => '<iframe src="https://piksera.com/video.mp4" width="560" height="315"></iframe>',
            ],
            [],//params
            $_COOKIE,//cookie
            [],//files
        ...
        $this->assertEquals($savedOption, '<iframe src="https://piksera.com/video.mp4" width="560" height="315"></iframe>');
