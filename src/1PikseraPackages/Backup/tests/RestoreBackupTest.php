...
namespace PikseraPackages\Backup\tests;

use PikseraPackages\Backup\GenerateBackup;
...
use PikseraPackages\Multilanguage\tests\MultilanguageTest;
...
//        });
        ...
        $restore = new \PikseraPackages\Backup\Restore();
