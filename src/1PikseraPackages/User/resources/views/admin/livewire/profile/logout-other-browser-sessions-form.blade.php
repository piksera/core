<x-piksera-ui::action-section>
    ...
    <x-slot name="content">
        ...
        <div class="flex items-center mt-2">
            <x-piksera-ui::button wire:click="confirmLogout" wire:loading.attr="disabled" @style('white-space: normal')>
                <?php _e('Logout Other Browser Sessions');?>
            </x-piksera-ui::button>

            <x-piksera-ui::action-message class="ml-3" on="loggedOut">
                <?php _e('Done');?>.
            </x-piksera-ui::action-message>
        </div>

        <!-- Logout Other Devices Confirmation Modal -->
        <x-piksera-ui::dialog-modal wire:model="confirmingLogout">
            <x-slot name="title">
                <?php _e('Logout Other Browser Sessions');?>
            </x-slot>
            ...
            <x-slot name="footer">
                <x-piksera-ui::secondary-button wire:click="$toggle('confirmingLogout')" wire:loading.attr="disabled">
                    <?php _e('Nevermind');?>
                </x-piksera-ui::secondary-button>

                <x-piksera-ui::button class="ml-2" wire:click="logoutOtherBrowserSessions" wire:loading.attr="disabled">
                    <?php _e('Logout Other Browser Sessions');?>
                </x-piksera-ui::button>
            </x-slot>
