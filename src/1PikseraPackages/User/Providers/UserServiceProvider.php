...
use PikseraPackages\User\Http\Livewire\Admin\LoginAsUserForm;
...
use PikseraPackages\User\Http\Livewire\LogoutOtherBrowserSessionsForm;
use PikseraPackages\User\Http\Livewire\TwoFactorAuthenticationForm;
use PikseraPackages\User\Services\RSAKeys;
...
class UserServiceProvider extends AuthServiceProvider
{
    ...
    {
        $this->app->register(\PikseraPackages\User\Providers\AuthServiceProvider::class);
        ...
        Livewire::component('admin::edit-user.two-factor-authentication-form', \PikseraPackages\User\Http\Livewire\Admin\TwoFactorAuthenticationForm::class);
        Livewire::component('admin::edit-user.logout-other-browser-sessions-form', \PikseraPackages\User\Http\Livewire\Admin\LogoutOtherBrowserSessionsForm::class);
    ...
    public function boot()
    {
        ...
        /**
         * @property \PikseraPackages\User\UserManager $user_manager
         */
     ...
     //   Passport::ignoreMigrations();
        ...
        Validator::extendImplicit(
            'terms',
            'PikseraPackages\User\Validators\TermsValidator@validate',
            'Terms are not accepted');
        Validator::extendImplicit(
            'temporary_email_check',
            'PikseraPackages\User\Validators\TemporaryEmailCheckValidator@validate',
