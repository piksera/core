...
//        );
    ...
    public function update(Request $request)
    {
        ...
        $tokenMd5 = \PikseraPackages\User\Models\PasswordReset::where('email', $request->get('email'))
        ...
        if (!empty($tokenMd5)) {
            ...
            if ($user != null) {
               ...
               //Auth::logoutOtherDevices($request->get('password'));
                ...
                \PikseraPackages\User\Models\PasswordReset::where('email', $tokenMd5->email)->where('token', $tokenMd5->token)->delete();
