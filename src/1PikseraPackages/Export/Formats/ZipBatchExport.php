...
namespace PikseraPackages\Export\Formats;
...
class ZipBatchExport extends DefaultExport
{
    ...
    public function start()
    {
        ...
        $zip->setArchiveComment("Piksera backup of the userfiles folder and db.
                \nThe Piksera version at the time of backup was " . MW_VERSION . "
