...
class Ui
{
    ...
    {
        $this->admin_logo_login = modules_url() . 'piksera/api/libs/mw-ui/assets/img/logo.svg';
        $this->logo_live_edit = modules_url() . 'piksera/api/libs/mw-ui/assets/img/logo-mobile.svg';
        if (mw_is_installed()) {
            $this->defaults();
        }
    }
