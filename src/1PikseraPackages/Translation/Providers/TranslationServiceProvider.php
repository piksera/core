...
namespace PikseraPackages\Translation\Providers;
...
use PikseraPackages\Translation\Models\TranslationKey;
use PikseraPackages\Translation\Repositories\TranslationKeyRepository;
use PikseraPackages\Translation\TranslationLoader;
           ...
           //return;
            ...
            $this->app->terminating(function () {
                ...
                if (!empty($getNewKeys)) {
                    ...
                    \Config::set('piksera.disable_model_cache', 1);
