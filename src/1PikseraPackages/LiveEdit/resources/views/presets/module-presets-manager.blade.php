...
...initPresetsManagerData,
        ...
        <div x-show="initPresetsManagerData.showEditTab=='main'"
            ...
            @else
                <x-piksera-ui::button class="btn btn-primary-outline" type="button"
                                         wire:click="$emit('saveModuleAsPreset')">@lang('Save as preset')</x-piksera-ui::button>
            @endif
                ...
                <form wire:submit.prevent="submit">
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <x-piksera-ui::button-animation
                            type="submit">@lang('Save')</x-piksera-ui::button-animation>
                    </div>
    ...
    <div>
        <x-piksera-ui::dialog-modal wire:model="areYouSureDeleteModalOpened">
            <x-slot name="title">
                <?php _e('Are you sure?'); ?>
            </x-slot>
            <x-slot name="content">
            ...
            <x-slot name="footer">
                <x-piksera-ui::button-animation wire:click="$toggle('areYouSureDeleteModalOpened')"
                                                   wire:loading.attr="disabled">
                    <?php _e('Cancel'); ?>
                </x-piksera-ui::button-animation>
                <x-piksera-ui::button-animation class="text-danger" wire:click="confirmDeleteSelectedItems()"
                                                   wire:loading.attr="disabled">
                    <?php _e('Delete'); ?>
                </x-piksera-ui::button-animation>
            </x-slot>
