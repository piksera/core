...
namespace PikseraPackages\LiveEdit\Http\Livewire\ItemsEditor;

class ModuleSettingsItemsEditorEditItemComponent extends AbstractModuleSettingsEditorComponent
{
    public string $view = 'piksera-live-edit::module-items-editor-edit-item';
    ...
    public function submit($options = [])
    {
        ...
        $this->emitTo('piksera-live-edit::module-items-editor-list', 'onItemChanged', ['moduleId' => $this->moduleId, 'item' => $newItem, 'isNew' => $isNewItem, 'itemId' => $newItem['itemId']]);
