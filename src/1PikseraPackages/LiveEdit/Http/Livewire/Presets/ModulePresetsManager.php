...
namespace PikseraPackages\LiveEdit\Http\Livewire\Presets;
...
{
    public $view = "piksera-live-edit::presets.module-presets-manager";
    ...
    public function getEditorSettings()
    {
        ...
        $editorSettings = [
            'config' => [
                ...
                'additionalButtonsView' => 'piksera-live-edit::presets.select-preset-button',
                'listColumns' => [
                    'name' => 'name',
                ],
            ],
