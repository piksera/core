...
//dump($cat_get_params);
    ...
    {
        $catObj = \PikseraPackages\Category\Models\Category::find($catId);
        $hasActiveProducts = \PikseraPackages\Category\Models\Category::hasActiveProductInSubcategories($catObj);
