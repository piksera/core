    ...
    <div class="container-fluid" >
        ...
        <div class="  navbar-collapse overflow-x-hidden" id="sidebar-menu">
            <ul class="navbar-nav navbar-nav-padding" id="mw-admin-main-navigation">
                ...
                @foreach(\PikseraPackages\Admin\Facades\AdminManager::getMenu('left_menu_top') as $item)
                ...
                @foreach(\PikseraPackages\Admin\Facades\AdminManager::getMenu('left_menu_bottom') as $item)
