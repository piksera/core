...
namespace PikseraPackages\Checkout\Http\Controllers;

use Illuminate\Http\Request;
use Illuminate\Routing\Controller;
use PikseraPackages\App\Traits\LiveEditTrait;
use PikseraPackages\Checkout\Http\Controllers\Traits\ContactInformationTrait;
use PikseraPackages\Checkout\Http\Controllers\Traits\PaymentTrait;
use PikseraPackages\Checkout\Http\Controllers\Traits\ShippingTrait;
