...
namespace PikseraPackages\Database\Traits;

use PikseraPackages\Database\Eloquent\Builder\MultilanguageCachedBuilder;
use PikseraPackages\Multilanguage\MultilanguageHelpers;
use PikseraPackages\Database\Eloquent\Builder\CachedBuilder;
...
trait CacheableQueryBuilderTrait
{
    ...
    protected function newBaseQueryBuilder()
    {
        ...
        $builder = new \PikseraPackages\Database\Query\CachedBuilder($conn, $grammar, $conn->getPostProcessor());
