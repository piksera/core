...
namespace PikseraPackages\CustomField\tests;
...
use PikseraPackages\Multilanguage\tests\MultilanguageTestBase;
...
//        MultilanguageTranslations::truncate();
    ...
    public function testAddCustomFieldValue()
    {
        ...
        $findCustomFieldValue = \PikseraPackages\CustomField\Models\CustomFieldValue::find($customFieldValueId);
    ...
    {
        $newCustomField = new \PikseraPackages\CustomField\Models\CustomField();
        ...
        $findCustomField = \PikseraPackages\CustomField\Models\CustomField::find($newCustomField->id);
