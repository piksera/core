...
namespace PikseraPackages\CustomField\Http\Livewire;

use PikseraPackages\Admin\Http\Livewire\AdminMwTopDialogIframeComponent;
use PikseraPackages\CustomField\CustomFieldsHelper;
...
class CustomFieldAddModalComponent extends AdminMwTopDialogIframeComponent
{
    ...
    {
        $existingFields = \PikseraPackages\CustomField\Models\CustomField::where('rel_type', $this->relType)
            ->groupBy('name_key')
