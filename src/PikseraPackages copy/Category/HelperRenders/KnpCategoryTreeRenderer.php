...
namespace PikseraPackages\Category\HelperRenders;

use Knp\Menu\MenuFactory;
use PikseraPackages\Category\HelperRenders\KnpCustomListRenderer as ListRenderer;
...
//        }
        if (!$tree_data) {
            $data_provider = new \PikseraPackages\Category\HelperRenders\CategoryTreeData($this->app);
