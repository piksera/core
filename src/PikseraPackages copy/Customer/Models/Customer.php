...
namespace PikseraPackages\Customer\Models;

use EloquentFilter\Filterable;
use Illuminate\Database\Eloquent\Model;
use PikseraPackages\Currency\Currency;
use PikseraPackages\Customer\Models\ModelFilters\CustomerFilter;
...
//    }
    ...
    {
        return $this->belongsTo(\PikseraPackages\User\Models\User::class);
    }
    ...
    public function cityAndCountry()
    {
        ...
        if (isset($this->addresses[0]->country_id)) {
            $findCountry = \PikseraPackages\Country\Models\Country::where('id', $this->addresses[0]->country_id)->first();
            if ($findCountry) {
