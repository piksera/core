...
Route::get('/register', '\PikseraPackages\User\Http\Controllers\UserRegisterController@registerForm')->name('register');
Route::post('/register', '\PikseraPackages\User\Http\Controllers\UserRegisterController@register')->name('register');
