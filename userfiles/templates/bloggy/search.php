            ...
            <div class="row">
                <div class="col-12 text-center">
                    <div class="m-auto allow-drop" style="max-width: 800px;">
                        <h1 class="hr"><?php _lang('Results found', 'templates/bloggy'); ?><span class="text-primary">.</span></h1>
                        <p class="lead"><em><?php _lang('Mentioning', 'templates/bloggy'); ?></em> &ldquo;<?php print $keywords; ?>&rdquo;</p>
                    </div>
                </div>
            </div>
        </div>
