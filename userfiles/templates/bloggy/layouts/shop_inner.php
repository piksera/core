                ...
                <div class="col-lg-10">
                                        ...
                                        <div class="col-12 d-flex">
                                            ...
                                            <div class="availability col-6 text-end text-right align-self-center">
                                                <?php if ($in_stock == true): ?>
                                                    <span class="text-success"><i class="mdi mdi-circle" style="font-size: 8px;"></i> <?php _lang("In Stock", 'templates/bloggy') ?></span> <span class="text-muted"><?php if ($available_qty != ''): ?>(<?php echo $available_qty; ?>)<?php endif; ?></span>
                                                <?php else: ?>
                                                    <span class="text-danger"><i class="mdi mdi-circle" style="font-size: 8px;"></i> <?php _lang("Out of Stock", 'templates/bloggy') ?></span>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 mt-3">
                                            <?php if (isset($content_data['sku'])): ?>
                                                <?php _lang("SKU", 'templates/bloggy') ?>
                                    ...
                                    <div class="row mb-5">
                                        <div class="col-12">
                                            <div class="description">
                                                <div class="edit mw-tpl-bloggy-product-description" field="content_body" rel="content">
                                                   ...
                                                   features — try to
                                                            limit each one to 5-8 words.", 'templates/bloggy') ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="edit safe-mode nodrop mt-5" field="related_products" rel="content">
                        <div class="col-12 text-start text-left">
                            <h5><?php _lang('Related products', 'templates/bloggy'); ?></h5>
