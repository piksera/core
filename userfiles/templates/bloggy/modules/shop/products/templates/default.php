...
<?php if (!empty($data)): ?>
    <div class="row shop-products pt-7">
        <?php foreach ($data as $item): ?>
            ...
            <div class="col-12 col-md-6 col-lg-4 col-lg-4 item-<?php print $item['id'] ?>" data-masonry-filter="<?php print $itemCats; ?>" itemscope
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-6 d-flex justify-content-end">
                                <?php if ($show_fields == false or ($show_fields != false and in_array('add_to_cart', $show_fields))): ?>
                                    ...
                                    <a href="javascript:;" onclick="mw.cart.add('.shop-products .item-<?php print $item['id'] ?>');" class="btn btn-primary"><i class="mdi mdi-cart"></i> <span class="name-of-product-shop mt-1"><?php _e("Add to cart"); ?></a>
                                    <?php else: ?>
                                        <span class="text-danger p-1"><i class="material-icons" style="font-size: 18px;">remove_shopping_cart</i> <?php _lang("Out of Stock", 'templates/bloggy') ?></span>
                                    <?php endif; ?>
                                <?php endif; ?>
                            </div>
                        </div>
