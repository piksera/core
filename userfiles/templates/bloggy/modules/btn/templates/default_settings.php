        ...
        <div class="mw-ui-col">
            <div class="mw-ui-col-container">
                ...
                <select class="mw-ui-field mw_option_field" name="button_style">
                    <option <?php if (!isset($style) OR $style == '' OR $style == 'btn-default') {print 'selected';} ?> value="btn-default"><?php _lang("Default Button", "templates/bloggy"); ?></option>
...
<!--                    <option --><?php //if ($style == '6') {print 'selected';} ?><!-- value="6">--><?php //_e("White Button"); ?><!--</option>-->
                    <option <?php if ($style == '7') {print 'selected';} ?> value="7"><?php _lang("Underlined White Link", "templates/bloggy"); ?></option>
                    <option <?php if ($style == '8') {print 'selected';} ?> value="8"><?php _lang("Blue Link", "templates/bloggy"); ?></option>
            ...
            <div class="mw-ui-col-container">
                ...
                <select class="mw-ui-field mw_option_field" name="button_size">
                    ...
                    <option <?php if ($size == 'btn-block') {
                        ...
                        <?php _lang("Large Block", "templates/bloggy"); ?>
                    </option>
                    ...
                    <option <?php if ($size == 'button-md btn-block') {
                        ...
                        <?php _lang("Medium Block", "templates/bloggy"); ?>
                    </option>
                </select>
            </div>
        </div>
