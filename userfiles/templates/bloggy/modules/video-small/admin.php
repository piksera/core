...
<div class="mw-ui-box-content">
    ...
    <div class="mw-ui-btn-nav mw-ui-btn-nav-tabs">
        <a class="mw-ui-btn active" href="javascript:;"><?php _lang("Upload Video", "templates/bloggy"); ?></a>
    </div>
    <div class="mw-ui-box mw-ui-box-content">
        <div class="tab" style="display: block">
            <div class="mw-ui-field-holder">
                <label class="mw-ui-label"><?php _lang("Upload Video from your computer", "templates/bloggy"); ?></label>
                ...
                <span class="mw-ui-btn" id="upload_btn"><span
                            class="mw-icon-upload"></span><?php _lang("Browse", "templates/bloggy"); ?></span>
            </div>


            <div class="mw-ui-progress" id="upload_status" style="display: none">
                <div style="width: 0%" class="mw-ui-progress-bar"></div>
                <div class="mw-ui-progress-info"><?php _lang("Status", "templates/bloggy"); ?>: <span class="mw-ui-progress-percent">0</span>
                </div>
            </div>
        </div>
