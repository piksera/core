                ...
                <div class="row">
                    <div class="order-2 order-lg-1 text-center text-sm-center text-lg-start text-lg-left  col-md-10 mx-auto col-lg-7 m-b-20 d-flex flex-column justify-content-center align-items-center">
                        <div class="allow-drop">
                            <h1 class="m-b-30">Making the web a better place with Bloggy</h1>
                    ...
                    <div class="order-1 order-lg-2 text-start text-left text-start text-left text-sm-center text-lg-start col-lg-5 m-b-20">
