...
<?php else: ?>
    ...
    <div id="user_login_holder_<?php print $params['id'] ?>">
        ...
        <p><?php _lang("If you already have an account" , "templates/bloggy"); ?> <br/><?php _lang("you can use it to log in." , "templates/bloggy"); ?><br/><br/></p>
        ...
        <form method="post" id="user_login_<?php print $params['id'] ?>" action="#" autocomplete="off">
            ...
            <div class="form-group">
                <input class="form-control input-lg" type="text" name="username" placeholder="<?php _lang("Username or E-mail" , "templates/bloggy"); ?>">
            </div>
            ...
            <div class="row">
                <div class="col-12 col-lg-6">
                    <div class="form-group">
                        <label class="styled-checkbox"><?php _lang("Remember me" , "templates/bloggy"); ?>
                ...
                <div class="col-12 col-lg-6">
                    <p><a href="<?php print forgot_password_url(); ?>"><?php _lang("Forgot your password ?" , "templates/bloggy"); ?></a></p>
                </div>
            </div>
            ...
            <button type="submit" class="btn btn-default btn-lg btn-block m-t-10"><?php _lang("Login" , "templates/bloggy"); ?></button>
        </form>
        ...
        <div class="act create">
            <a href="<?php print register_url(); ?>" class="js-show-register-window"><span><?php _lang("Create New Account" , "templates/bloggy"); ?></span></a>
        </div>
    </div>
<?php endif; ?>
