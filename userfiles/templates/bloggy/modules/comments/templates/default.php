        ...
        <div class="col-lg-6 mx-auto">
            <div class="bg-silver p-30">
                        ...
                        <div class="reviews">
                                                        ...
                                                        <div class="info">
                                                            ...
                                                            <?php if ($required_moderation != false and $comment['is_moderated'] == 0): ?>
                                                                <em class="comment-require-moderation">
                                                                    <?php _lang("Your comment requires moderation" , "templates/bloggy"); ?>
                                                                </em><br/>
                                                            <?php endif; ?>
                                                        </div>
                                ...
                                <div class="row m-t-50">
                                    <div class="col-md-12">
                                        <div class="text-center m-b-50">
                                            <p class="bold"><?php _lang("No comments", "templates/bloggy"); ?></p>
                                        </div>
                                    </div>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if ($are_disabled == false) : ?>
                                <?php if (!$login_required or $cur_user != false): ?>
                                    <a href="javascript:;" class="js-show-review-form btn btn-primary btn-block"><?php _lang("Leave a Comment", "templates/bloggy"); ?></a>
                                <?php endif; ?>
                            <?php endif; ?>
                        </div>
                    </div>
                ...
                <?php if ($are_disabled == false) : ?>
                        ...
                        <div class="row leave-review js-review-form m-t-20" style="display: none;">
                            <div class="col-12">
                                <div class="right-side-x">
                                    <div class="reviews">
                                        <h4 class="m-b-20"><?php _lang("Leave a Comment", "templates/bloggy"); ?></h4>
                                    </div>
                                                ...
                                                <div class="col-12">
                                                    <?php if ($cur_user == false) : ?>
                                                        <div class="form-group">
                                                            <label class="control-label" for="comment_name"><?php _lang("Name", "templates/bloggy"); ?></label>
                                                            <input class="form-control" id="comment_name" name="comment_name" type="text" placeholder="<?php _lang("Full name", "templates/bloggy"); ?>">
                                                        </div>

                                                        <div class="form-group">
                                                            <label class="control-label" for="comment_email"><?php _lang("E-mail", "templates/bloggy"); ?></label>
                                                            <input class="form-control" id="comment_email" name="comment_email" type="email" placeholder=""<?php _lang("E-mail address", "templates/bloggy"); ?>">
                                                        </div>
                                                    <?php else: ?>
                                                        <div class="comments-user-profile" style="margin-bottom: 5px;">
                                                            ...
                                                            <a href="<?php print logout_url() ?>" class="mw-ui-btn mw-ui-btn-outline mw-ui-btn-small mw-ui-btn-default float-right "><?php _lang("Logout", "templates/bloggy"); ?></a>
                                                        </div>
                                                    <?php endif; ?>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label" for="comment_body"><?php _lang("Message", "templates/bloggy"); ?></label>
                                                        <textarea class="form-control" id="comment_body" name="comment_body" style="height:200px;" placeholder="<?php _lang("Type your message here", "templates/bloggy"); ?>"></textarea>
                                                    </div>

                                                    <button type="submit" class="btn btn-primary btn-block"><?php _lang('Send Message', "templates/bloggy"); ?></button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                    ...
                    <?php else : ?>
                        <div class="alert">
                            <?php _lang("You have to", "templates/bloggy"); ?>
                            <a href='<?php print login_url(); ?>' class="comments-login-link">
                                <?php _lang("log in", "templates/bloggy"); ?>
                            </a>
                            <?php _lang("or", "templates/bloggy"); ?>
                            <a class="comments-register-link" href='<?php print register_url(); ?>'>
                                <?php _lang("register", "templates/bloggy"); ?>
                            </a>
                            <?php _lang("to post a comment", "templates/bloggy"); ?>
                            .
                        </div>
                    <?php endif; ?>
                <?php endif; ?>
