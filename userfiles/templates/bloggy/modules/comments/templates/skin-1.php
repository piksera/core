        ...
        <div class="row leave-review js-review-form m-t-20" style="display: none;">
            <div class="col-12">
                <div class="right-side-x">
                    <div class="reviews">
                        <h4><?php _lang("Leave a Comment", "templates/bloggy"); ?></h4>
                    </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <?php else: ?>
                                        <div class="comments-user-profile" style="margin-bottom: 5px;">
                                            <?php _lang("You are commenting as", "templates/bloggy"); ?>:
                                            <span class="comments-user-profile-username"> <?php print user_name($cur_user_data['id']); ?> </span>
                                            <a href="<?php print logout_url('logout'); ?>" class="mw-ui-btn mw-ui-btn-outline mw-ui-btn-small mw-ui-btn-default float-right "><?php _lang("Logout", "templates/bloggy"); ?></a>
                                        </div>
                                    <?php endif; ?>
