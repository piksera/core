...
<?php if ($footer == 'true'): ?>
    <footer class="p-t-60 p-b-60">
        <div class="container">
            <div class="edit nodrop safe-mode" field="bloggy_footer" rel="global">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-12 col-lg-5 mx-auto text-center text-lg-start m-b-40 allow-drop">
                        ...
                        <br/>
                        <p><?php _lang('Bloggy is free open source drag and drop website builder and CMS. It is under MIT license and we use Laravel PHP framework', 'templates/bloggy'); ?></p>
                    </div>
                    ...
                    <div class="col-12 col-sm col-lg-6 col-lg mx-auto text-white text-center text-sm-end allow-drop">
                        <h6 class="m-t-5"><?php _lang('Social Networks', 'templates/bloggy'); ?></h6>
            ...
            <div class="row">
                <div class="col-md-6 text-center text-md-start edit" field="bloggy_footer_copyright" rel="global">
