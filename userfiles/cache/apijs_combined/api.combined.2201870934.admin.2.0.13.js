(function () {
    ...
    mw.settings = {
        ...
        template_url: 'http://127.0.0.1:8000/userfiles/templates/bootstrap5/',
        modules_url: 'http://127.0.0.1:8000/userfiles/modules/',
        includes_url: 'http://127.0.0.1:8000/userfiles/modules/microweber/',
        upload_url: 'http://127.0.0.1:8000/api/upload/',
        api_url: 'http://127.0.0.1:8000/api/',
        libs_url: 'http://127.0.0.1:8000/userfiles/modules/microweber/api/libs/',
        api_html: 'http://127.0.0.1:8000/api_html/',
    ...
    const Ziggy = {"url":"http:\/\/127.0.0.1:8000","port":8000,"defaults":{},"routes":{"admin.live-edit.index":{"uri":"admin\/live-edit","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"api.live-edit.get-top-right-menu":{"uri":"api\/live-edit\/get-top-right-menu","methods":["GET","HEAD"]},"live_edit.module_settings":{"uri":"api\/live_edit\/live_edit.module_settings","methods":["GET","HEAD"]},"admin.livewire.components.render-component":{"uri":"admin-livewire-components\/render-component","methods":["GET","HEAD"]},"register":{"uri":"register","methods":["POST"]},"admin.users.index":{"uri":"admin\/users","methods":["GET","HEAD"]},"admin.users.create":{"uri":"admin\/users\/create","methods":["GET","HEAD"]},"admin.users.store":{"uri":"admin\/users","methods":["POST"]},"admin.users.show":{"uri":"admin\/users\/{user}","methods":["GET","HEAD"]},"admin.users.edit":{"uri":"admin\/users\/{user}\/edit","methods":["GET","HEAD"]},"admin.users.update":{"uri":"admin\/users\/{user}","methods":["PUT","PATCH"]},"admin.users.destroy":{"uri":"admin\/users\/{user}","methods":["DELETE"]},"admin.profile.show":{"uri":"admin\/user\/profile","methods":["GET","HEAD"]},"logout":{"uri":"logout","methods":["GET","HEAD"]},"logout.submit":{"uri":"logout","methods":["POST"]},"verification.verify":{"uri":"email\/verify\/{id}\/{hash}","methods":["GET","HEAD"]},"verification.resend":{"uri":"email\/verify-resend\/{id}\/{hash}","methods":["GET","HEAD"]},"verification.send":{"uri":"email\/verify-resend\/{id}\/{hash}","methods":["POST"]},"password.request":{"uri":"forgot-password","methods":["GET","HEAD"]},"password.email":{"uri":"forgot-password","methods":["POST"]},"password.reset":{"uri":"reset-password\/{token}","methods":["GET","HEAD"]},"password.update":{"uri":"reset-password","methods":["POST"]},"api.users.export_my_data":{"uri":"api\/users\/export_my_data","methods":["GET","HEAD"]},"admin.login":{"uri":"admin\/login","methods":["GET","HEAD"]},"api.save_user":{"uri":"api\/save_user","methods":["POST"]},"api.user_login":{"uri":"api\/user_login","methods":["POST"]},"api.user.login":{"uri":"api\/user\/login","methods":["POST"]},"api.user.logout":{"uri":"api\/user\/logout","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"api.user.register":{"uri":"api\/user\/register","methods":["POST"]},"api.user.password.email":{"uri":"api\/user\/forgot-password","methods":["POST"]},"api.user.password.update":{"uri":"api\/user\/reset-password","methods":["POST"]},"api.user.profile.update":{"uri":"api\/user\/profile-update","methods":["POST"]},"api.api.logout":{"uri":"api\/logout","methods":["GET","HEAD"]},"api.user.index":{"uri":"api\/user","methods":["GET","HEAD"]},"api.user.store":{"uri":"api\/user","methods":["POST"]},"api.user.show":{"uri":"api\/user\/{user}","methods":["GET","HEAD"]},"api.user.update":{"uri":"api\/user\/{user}","methods":["PUT","PATCH"]},"api.user.destroy":{"uri":"api\/user\/{user}","methods":["DELETE"]},"api.image-generate-tn-request":{"uri":"api\/image-generate-tn-request\/{cache_id}","methods":["GET","HEAD"]},"api.save_media":{"uri":"api\/save_media","methods":["POST"]},"api.content.get_admin_js_tree_json":{"uri":"api\/content\/get_admin_js_tree_json","methods":["GET","HEAD"]},"api.content.save_edit":{"uri":"api\/save_edit","methods":["POST"]},"api.content.set_published":{"uri":"api\/content\/set_published","methods":["POST"]},"api.content.set_unpublished":{"uri":"api\/content\/set_unpublished","methods":["POST"]},"api.content.reorder":{"uri":"api\/content\/reorder","methods":["POST"]},"api.content.reset_edit":{"uri":"api\/content\/reset_edit","methods":["POST"]},"api.content.reset_modules_settings":{"uri":"api\/content\/reset_modules_settings","methods":["POST"]},"api.content.bulk_assign":{"uri":"api\/content\/bulk_assign","methods":["POST"]},"api.content.copy":{"uri":"api\/content\/copy","methods":["POST"]},"api.content.related.add":{"uri":"api\/content\/related_content\/add","methods":["POST"]},"api.content.related.remove":{"uri":"api\/content\/related_content\/remove","methods":["POST"]},"api.content.related.reorder":{"uri":"api\/content\/related_content\/reorder","methods":["POST"]},"api.content.redirect_to_content":{"uri":"api\/content\/redirect_to_content","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"api.content.delete":{"uri":"api\/content\/delete","methods":["POST"]},"api.content.get_link_admin":{"uri":"api\/content\/get_link_admin","methods":["GET","HEAD"]},"api.content.index":{"uri":"api\/content","methods":["GET","HEAD"]},"api.content.store":{"uri":"api\/content","methods":["POST"]},"api.content.show":{"uri":"api\/content\/{content}","methods":["GET","HEAD"]},"api.content.update":{"uri":"api\/content\/{content}","methods":["PUT","PATCH"]},"api.content.destroy":{"uri":"api\/content\/{content}","methods":["DELETE"]},"admin.content.index":{"uri":"admin\/content","methods":["GET","HEAD"]},"admin.content.create":{"uri":"admin\/content\/create","methods":["GET","HEAD"]},"admin.content.store":{"uri":"admin\/content","methods":["POST"]},"admin.content.edit":{"uri":"admin\/content\/{content}\/edit","methods":["GET","HEAD"]},"admin.content.update":{"uri":"admin\/content\/{content}","methods":["PUT","PATCH"]},"admin.content.destroy":{"uri":"admin\/content\/{content}","methods":["DELETE"]},"admin.content.builder.index":{"uri":"admin\/content-form-builder","methods":["GET","HEAD"]},"admin.category.index":{"uri":"admin\/category","methods":["GET","HEAD"]},"admin.category.create":{"uri":"admin\/category\/create","methods":["GET","HEAD"]},"admin.category.store":{"uri":"admin\/category","methods":["POST"]},"admin.category.show":{"uri":"admin\/category\/{category}","methods":["GET","HEAD"]},"admin.category.edit":{"uri":"admin\/category\/{category}\/edit","methods":["GET","HEAD"]},"admin.category.update":{"uri":"admin\/category\/{category}","methods":["PUT","PATCH"]},"admin.category.destroy":{"uri":"admin\/category\/{category}","methods":["DELETE"]},"admin.shop.category.index":{"uri":"admin\/shop\/category","methods":["GET","HEAD"]},"admin.shop.category.create":{"uri":"admin\/shop\/category\/create","methods":["GET","HEAD"]},"admin.shop.category.store":{"uri":"admin\/shop\/category","methods":["POST"]},"admin.shop.category.show":{"uri":"admin\/shop\/category\/{category}","methods":["GET","HEAD"]},"admin.shop.category.edit":{"uri":"admin\/shop\/category\/{category}\/edit","methods":["GET","HEAD"]},"admin.shop.category.update":{"uri":"admin\/shop\/category\/{category}","methods":["PUT","PATCH"]},"admin.shop.category.destroy":{"uri":"admin\/shop\/category\/{category}","methods":["DELETE"]},"api.":{"uri":"api\/mw_save_license","methods":["POST"]},"api.category.delete":{"uri":"api\/category\/delete\/{id}","methods":["DELETE"]},"api.category.delete-bulk":{"uri":"api\/category\/delete-bulk","methods":["DELETE"]},"api.category.hidden-bulk":{"uri":"api\/category\/hidden-bulk","methods":["POST"]},"api.category.visible-bulk":{"uri":"api\/category\/visible-bulk","methods":["POST"]},"api.category.move-bulk":{"uri":"api\/category\/move-bulk","methods":["POST"]},"api.category.index":{"uri":"api\/category","methods":["GET","HEAD"]},"api.category.store":{"uri":"api\/category","methods":["POST"]},"api.category.show":{"uri":"api\/category\/{category}","methods":["GET","HEAD"]},"api.category.update":{"uri":"api\/category\/{category}","methods":["PUT","PATCH"]},"api.category.destroy":{"uri":"api\/category\/{category}","methods":["DELETE"]},"api.template.":{"uri":"api\/template\/template-settings-sidebar","methods":["GET","HEAD"]},"api.template.change":{"uri":"api\/template\/change","methods":["GET","HEAD"]},"api.template.compile_admin_css":{"uri":"api\/template\/compile_admin_css","methods":["GET","HEAD"]},"api.template.compile_admin_live_edit_css":{"uri":"api\/template\/compile_admin_live_edit_css","methods":["GET","HEAD"]},"api.template.get_admin_css_url":{"uri":"api\/template\/get_admin_css_url","methods":["GET","HEAD"]},"api.template.reset_admin_stylesheet":{"uri":"api\/template\/reset_admin_stylesheet","methods":["GET","HEAD"]},"api.template.reset_admin_stylesheet_colors":{"uri":"api\/template\/reset_admin_stylesheet_colors","methods":["GET","HEAD"]},"current_template_save_custom_css":{"uri":"api\/current_template_save_custom_css","methods":["POST"]},"template_remove_custom_css":{"uri":"api\/layouts\/template_remove_custom_css","methods":["POST"]},"delete_compiled_css":{"uri":"api\/template\/delete_compiled_css","methods":["GET","HEAD"]},"template_compile_css":{"uri":"api\/template\/compile_css","methods":["GET","HEAD"]},"api.file-manager.list":{"uri":"api\/file-manager\/list","methods":["GET","HEAD"]},"api.file-manager.delete":{"uri":"api\/file-manager\/file","methods":["DELETE"]},"api.file-manager.create-folder":{"uri":"api\/file-manager\/create-folder","methods":["POST"]},"admin.marketplace.index":{"uri":"admin\/marketplace","methods":["GET","HEAD"]},"admin.blog.filter.get-custom-fields-table":{"uri":"admin\/blog\/filter\/get-custom-fields-table","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"standalone-updater.about-new-version":{"uri":"admin\/standalone-updater\/about-new-version","methods":["GET","HEAD"]},"api.standalone-updater.delete-temp":{"uri":"api\/standalone-updater\/delete-temp","methods":["GET","HEAD"]},"api.standalone-updater.update-now":{"uri":"api\/standalone-updater\/update-now","methods":["POST"]},"api.standalone-updater.remove-dashboard-notice":{"uri":"api\/standalone-updater\/remove-dashboard-notice","methods":["GET","HEAD"]},"admin.settings.index":{"uri":"admin\/settings","methods":["GET","HEAD"]},"admin.contact-form.index":{"uri":"admin\/contact-form","methods":["GET","HEAD"]},"admin.newsletter.upload-subscribers-list":{"uri":"admin\/modules\/newsletter\/upload-subscribers-list","methods":["POST"]},"admin.newsletter.index":{"uri":"admin\/modules\/newsletter","methods":["GET","HEAD"]},"admin.newsletter.subscribers":{"uri":"admin\/modules\/newsletter\/subscribers","methods":["GET","HEAD"]},"admin.newsletter.lists":{"uri":"admin\/modules\/newsletter\/lists","methods":["GET","HEAD"]},"admin.newsletter.templates":{"uri":"admin\/modules\/newsletter\/templates","methods":["GET","HEAD"]},"admin.newsletter.sender-accounts":{"uri":"admin\/modules\/newsletter\/sender-accounts","methods":["GET","HEAD"]},"admin.newsletter.settings":{"uri":"admin\/modules\/newsletter\/settings","methods":["GET","HEAD"]},"admin.newsletter.templates.edit":{"uri":"admin\/modules\/newsletter\/templates\/edit\/{id}","methods":["GET","HEAD"]},"admin.newsletter.templates.preview":{"uri":"admin\/modules\/newsletter\/templates\/preview\/{id}","methods":["GET","HEAD"]},"admin.newsletter.preview-email-template-iframe":{"uri":"admin\/modules\/newsletter\/preview-email-template-iframe","methods":["GET","HEAD"]},"admin.newsletter.sender-accounts.save":{"uri":"admin\/modules\/newsletter\/sender-accounts\/save","methods":["POST"]},"web.newsletter.unsubscribe":{"uri":"web\/modules\/newsletter\/unsubscribe","methods":["GET","HEAD"]},"admin.import-export-tool.upload-feed":{"uri":"admin\/import-export-tool\/upload-feed","methods":["POST"]},"admin.import-export-tool.import-wizard":{"uri":"admin\/import-export-tool\/import-wizard","methods":["GET","HEAD"]},"admin.import-export-tool.export-wizard":{"uri":"admin\/import-export-tool\/export-wizard","methods":["GET","HEAD"]},"admin.import-export-tool.export-wizard-file":{"uri":"admin\/import-export-tool\/export-wizard\/file\/{id}","methods":["GET","HEAD"]},"admin.import-export-tool.delete-wizard-file":{"uri":"admin\/import-export-tool\/delete-wizard\/file\/{id}","methods":["GET","HEAD"]},"admin.import-export-tool.index.main":{"uri":"admin\/import-export-tool","methods":["GET","HEAD"]},"admin.import-export-tool.install":{"uri":"admin\/import-export-tool\/install","methods":["GET","HEAD"]},"admin.import-export-tool.index":{"uri":"admin\/import-export-tool\/index","methods":["GET","HEAD"]},"admin.import-export-tool.import":{"uri":"admin\/import-export-tool\/import\/{id}","methods":["GET","HEAD"]},"admin.import-export-tool.import-start":{"uri":"admin\/import-export-tool\/import-start\/{id}","methods":["GET","HEAD"]},"admin.import-export-tool.import-delete":{"uri":"admin\/import-export-tool\/import-delete\/{id}","methods":["GET","HEAD"]},"admin.import-export-tool.index-exports":{"uri":"admin\/import-export-tool\/index-exports","methods":["GET","HEAD"]},"admin.comments.index":{"uri":"admin\/comments","methods":["GET","HEAD"]},"admin.google_analytics.index":{"uri":"admin\/google-analytics","methods":["GET","HEAD"]},"admin.shop.dashboard":{"uri":"admin\/shop\/dashboard","methods":["GET","HEAD"]},"admin.shop.filter.get-custom-fields-table":{"uri":"admin\/shop\/filter\/get-custom-fields-table","methods":["POST"]},"api.editor.template_settings_v2.settings":{"uri":"api\/editor\/template_settings_v2\/list","methods":["GET","HEAD"]},"livewire.message":{"uri":"livewire\/message\/{name}","methods":["POST"]},"livewire.upload-file":{"uri":"livewire\/upload-file","methods":["POST"]},"livewire.preview-file":{"uri":"livewire\/preview-file\/{filename}","methods":["GET","HEAD"]},"login":{"uri":"login","methods":["GET","HEAD"]},"two-factor.login":{"uri":"two-factor-challenge","methods":["GET","HEAD"]},"two-factor.enable":{"uri":"user\/two-factor-authentication","methods":["POST"]},"two-factor.disable":{"uri":"user\/two-factor-authentication","methods":["DELETE"]},"two-factor.qr-code":{"uri":"user\/two-factor-qr-code","methods":["GET","HEAD"]},"two-factor.recovery-codes":{"uri":"user\/two-factor-recovery-codes","methods":["GET","HEAD"]},"api.option.save":{"uri":"api\/save_option","methods":["POST"]},"admin.language.save":{"uri":"admin\/language\/save","methods":["POST"]},"admin.language.import":{"uri":"admin\/language\/import","methods":["POST"]},"admin.language.export":{"uri":"admin\/language\/export","methods":["POST"]},"admin.language.send_to_us":{"uri":"admin\/language\/send_to_us","methods":["POST"]},"admin.language.import_missing_translations":{"uri":"admin\/language\/import_missing_translations","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"api.page.index":{"uri":"api\/page","methods":["GET","HEAD"]},"api.page.store":{"uri":"api\/page","methods":["POST"]},"api.page.show":{"uri":"api\/page\/{page}","methods":["GET","HEAD"]},"api.page.update":{"uri":"api\/page\/{page}","methods":["PUT","PATCH"]},"api.page.destroy":{"uri":"api\/page\/{page}","methods":["DELETE"]},"admin.page.index":{"uri":"admin\/page","methods":["GET","HEAD"]},"admin.page.create":{"uri":"admin\/page\/create","methods":["GET","HEAD"]},"admin.page.store":{"uri":"admin\/page","methods":["POST"]},"admin.page.edit":{"uri":"admin\/page\/{page}\/edit","methods":["GET","HEAD"]},"admin.page.update":{"uri":"admin\/page\/{page}","methods":["PUT","PATCH"]},"admin.page.destroy":{"uri":"admin\/page\/{page}","methods":["DELETE"]},"admin.page.design":{"uri":"admin\/page\/design","methods":["GET","HEAD"]},"api.menu.add.content":{"uri":"api\/menu\/add\/content","methods":["POST"]},"api.menu.delete":{"uri":"api\/menu\/delete","methods":["POST"]},"api.menu.create":{"uri":"api\/menu\/create","methods":["POST"]},"api.menu.item.save":{"uri":"api\/menu\/item\/save","methods":["POST"]},"api.menu.item.edit":{"uri":"api\/menu\/item\/edit","methods":["POST"]},"api.menu.item.delete":{"uri":"api\/menu\/item\/delete\/{id}","methods":["POST"]},"api.menu.item.reorder":{"uri":"api\/menu\/item\/reorder","methods":["POST"]},"api.v2.menu.index":{"uri":"api\/v2\/menu","methods":["GET","HEAD"]},"api.v2.menu.store":{"uri":"api\/v2\/menu","methods":["POST"]},"api.v2.menu.show":{"uri":"api\/v2\/menu\/{menu}","methods":["GET","HEAD"]},"api.v2.menu.update":{"uri":"api\/v2\/menu\/{menu}","methods":["PUT","PATCH"]},"api.v2.menu.destroy":{"uri":"api\/v2\/menu\/{menu}","methods":["DELETE"]},"admin.product.index":{"uri":"admin\/shop\/product","methods":["GET","HEAD"]},"admin.product.create":{"uri":"admin\/shop\/product\/create","methods":["GET","HEAD"]},"admin.product.store":{"uri":"admin\/shop\/product","methods":["POST"]},"admin.product.edit":{"uri":"admin\/shop\/product\/{product}\/edit","methods":["GET","HEAD"]},"admin.product.update":{"uri":"admin\/shop\/product\/{product}","methods":["PUT","PATCH"]},"admin.product.destroy":{"uri":"admin\/shop\/product\/{product}","methods":["DELETE"]},"api.product.quick-view":{"uri":"api\/product\/quick-view","methods":["GET","HEAD"]},"api.product.index":{"uri":"api\/product","methods":["GET","HEAD"]},"api.product.store":{"uri":"api\/product","methods":["POST"]},"api.product.show":{"uri":"api\/product\/{product}","methods":["GET","HEAD"]},"api.product.update":{"uri":"api\/product\/{product}","methods":["PUT","PATCH"]},"api.product.destroy":{"uri":"api\/product\/{product}","methods":["DELETE"]},"api.product_variant.index":{"uri":"api\/product_variant","methods":["GET","HEAD"]},"api.product_variant.store":{"uri":"api\/product_variant","methods":["POST"]},"api.product_variant.show":{"uri":"api\/product_variant\/{product_variant}","methods":["GET","HEAD"]},"api.product_variant.update":{"uri":"api\/product_variant\/{product_variant}","methods":["PUT","PATCH"]},"api.product_variant.destroy":{"uri":"api\/product_variant\/{product_variant}","methods":["DELETE"]},"api.post.index":{"uri":"api\/post","methods":["GET","HEAD"]},"api.post.store":{"uri":"api\/post","methods":["POST"]},"api.post.show":{"uri":"api\/post\/{post}","methods":["GET","HEAD"]},"api.post.update":{"uri":"api\/post\/{post}","methods":["PUT","PATCH"]},"api.post.destroy":{"uri":"api\/post\/{post}","methods":["DELETE"]},"admin.post.index":{"uri":"admin\/post","methods":["GET","HEAD"]},"admin.post.create":{"uri":"admin\/post\/create","methods":["GET","HEAD"]},"admin.post.store":{"uri":"admin\/post","methods":["POST"]},"admin.post.edit":{"uri":"admin\/post\/{post}\/edit","methods":["GET","HEAD"]},"admin.post.update":{"uri":"admin\/post\/{post}","methods":["PUT","PATCH"]},"admin.post.destroy":{"uri":"admin\/post\/{post}","methods":["DELETE"]},"admin.order.abandoned":{"uri":"admin\/order\/abandoned","methods":["GET","HEAD"]},"admin.order.index":{"uri":"admin\/order","methods":["GET","HEAD"]},"admin.order.create":{"uri":"admin\/order\/create","methods":["GET","HEAD"]},"admin.order.show":{"uri":"admin\/order\/{order}","methods":["GET","HEAD"]},"api.order.index":{"uri":"api\/order","methods":["GET","HEAD"]},"api.order.store":{"uri":"api\/order","methods":["POST"]},"api.order.show":{"uri":"api\/order\/{order}","methods":["GET","HEAD"]},"api.order.update":{"uri":"api\/order\/{order}","methods":["PUT","PATCH"]},"api.order.destroy":{"uri":"api\/order\/{order}","methods":["DELETE"]},"checkout.cart":{"uri":"checkout\/cart","methods":["GET","HEAD"]},"checkout.contact_information":{"uri":"checkout\/contact-information","methods":["GET","HEAD"]},"checkout.contact_information_save":{"uri":"checkout\/contact-information-save","methods":["POST"]},"checkout.shipping_method":{"uri":"checkout\/shipping-method","methods":["GET","HEAD"]},"checkout.shipping_method_change":{"uri":"checkout\/shipping-method-change","methods":["POST"]},"checkout.shipping_method_save":{"uri":"checkout\/shipping-method-save","methods":["POST"]},"checkout.payment_method":{"uri":"checkout\/payment-method","methods":["GET","HEAD"]},"checkout.payment_method_change":{"uri":"checkout\/payment-method-change","methods":["POST"]},"checkout.payment_method_save":{"uri":"checkout\/payment-method-save","methods":["POST"]},"checkout.login":{"uri":"checkout\/login","methods":["GET","HEAD"]},"checkout.forgot_password":{"uri":"checkout\/forgot-password","methods":["GET","HEAD"]},"checkout.register":{"uri":"checkout\/register","methods":["GET","HEAD"]},"checkout.finish":{"uri":"checkout\/finish\/{id}","methods":["GET","HEAD"]},"api.checkout.":{"uri":"api\/checkout\/validate","methods":["POST"]},"shop.shipping.set_provider":{"uri":"api\/shop\/shipping\/set_provider","methods":["GET","POST","HEAD"]},"api.offer.store":{"uri":"api\/offer_save","methods":["POST"]},"api.offer.delete":{"uri":"api\/offer_delete","methods":["POST"]},"api.offer.get_all":{"uri":"api\/offers_get_all","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"api.post.form":{"uri":"api\/post_form","methods":["POST"]},"admin.backup.restore":{"uri":"admin\/backup\/restore","methods":["GET","HEAD"]},"admin.backup.start":{"uri":"admin\/backup\/start","methods":["GET","HEAD"]},"admin.backup.download":{"uri":"admin\/backup\/download","methods":["GET","HEAD"]},"admin.backup.generate-session-id":{"uri":"admin\/backup\/generate-session-id","methods":["GET","HEAD"]},"admin.backup.upload":{"uri":"admin\/backup\/upload","methods":["POST"]},"admin.backup.delete":{"uri":"admin\/backup\/delete","methods":["POST"]},"admin.backup.language.export":{"uri":"admin\/backup\/language\/export","methods":["POST"]},"admin.backup.language.upload":{"uri":"admin\/backup\/language\/upload","methods":["POST"]},"admin.customers.delete":{"uri":"admin\/customers\/delete","methods":["POST"]},"admin.customers.index":{"uri":"admin\/customers","methods":["GET","HEAD"]},"admin.customers.create":{"uri":"admin\/customers\/create","methods":["GET","HEAD"]},"admin.customers.store":{"uri":"admin\/customers","methods":["POST"]},"admin.customers.show":{"uri":"admin\/customers\/{customer}","methods":["GET","HEAD"]},"admin.customers.edit":{"uri":"admin\/customers\/{customer}\/edit","methods":["GET","HEAD"]},"admin.customers.update":{"uri":"admin\/customers\/{customer}","methods":["PUT","PATCH"]},"admin.customers.destroy":{"uri":"admin\/customers\/{customer}","methods":["DELETE"]},"admin.notification.read":{"uri":"admin\/notification\/read","methods":["POST"]},"admin.notification.reset":{"uri":"admin\/notification\/reset","methods":["POST"]},"admin.notification.delete":{"uri":"admin\/notification\/delete","methods":["POST"]},"admin.notification.test_mail":{"uri":"admin\/notification\/test_mail","methods":["POST"]},"admin.notification.index":{"uri":"admin\/notification","methods":["GET","HEAD"]},"api.multilanguage.geolocaiton_test":{"uri":"api\/multilanguage\/geolocaiton_test","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"api.multilanguage.change_language":{"uri":"api\/multilanguage\/change_language","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"admin.multilanguage.index":{"uri":"admin\/multilanguage","methods":["GET","HEAD"]},"api.module.list":{"uri":"api\/module\/list","methods":["GET","HEAD"]},"api.module.getSkins":{"uri":"api\/module\/getSkins","methods":["GET","HEAD"]},"admin.module.index":{"uri":"admin\/modules","methods":["GET","HEAD"]},"admin.module.view":{"uri":"admin\/module\/view","methods":["GET","HEAD"]},"debugbar.openhandler":{"uri":"_debugbar\/open","methods":["GET","HEAD"]},"debugbar.clockwork":{"uri":"_debugbar\/clockwork\/{id}","methods":["GET","HEAD"]},"debugbar.assets.css":{"uri":"_debugbar\/assets\/stylesheets","methods":["GET","HEAD"]},"debugbar.assets.js":{"uri":"_debugbar\/assets\/javascript","methods":["GET","HEAD"]},"debugbar.cache.delete":{"uri":"_debugbar\/cache\/{key}\/{tags?}","methods":["DELETE"]},"api.coupon_apply":{"uri":"api\/coupon_apply","methods":["POST"]},"api.coupons_delete_session":{"uri":"api\/coupons_delete_session","methods":["POST"]},"api.coupons_save_coupon":{"uri":"api\/coupons_save_coupon","methods":["POST"]},"api.coupon_delete":{"uri":"api\/coupon_delete","methods":["POST"]},"api.save_mail_template":{"uri":"api\/save_mail_template","methods":["POST"]},"api.delete_mail_template":{"uri":"api\/delete_mail_template","methods":["POST"]},"adminadmin.index":{"uri":"admin","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"admin.web-app-manifest":{"uri":"admin\/manifest.json","methods":["GET","HEAD"]},"editor_tools":{"uri":"editor_tools\/{all}","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"],"wheres":{"all":".*"}},"adminadmin.all":{"uri":"admin\/{all}","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"],"wheres":{"all":".*"}},"apijs":{"uri":"apijs\/{all}","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"],"wheres":{"all":".*"}},"set_app_lang":{"uri":"api\/set_app_lang","methods":["GET","HEAD"]},"csrf-validate-token":{"uri":"csrf-validate-token","methods":["POST"]},"csrf":{"uri":"csrf","methods":["POST"]},"module":{"uri":"module\/{all}","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"],"wheres":{"all":".*"}},"api":{"uri":"api\/{all}","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"],"wheres":{"all":".*"}},"api_html":{"uri":"api_html\/{all}","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"],"wheres":{"all":".*"}},"apiapi_nosession.all":{"uri":"api_nosession\/{all}","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"],"wheres":{"all":".*"}},"api_nosession":{"uri":"api_nosession","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"home":{"uri":"\/","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"robots":{"uri":"robots.txt","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"ads-txt":{"uri":"ads.txt","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"sitemap.index":{"uri":"sitemap.xml","methods":["GET","HEAD"]},"sitemap.categories":{"uri":"sitemap.xml\/categories","methods":["GET","HEAD"]},"sitemap.tags":{"uri":"sitemap.xml\/tags","methods":["GET","HEAD"]},"sitemap.products":{"uri":"sitemap.xml\/products","methods":["GET","HEAD"]},"sitemap.posts":{"uri":"sitemap.xml\/posts","methods":["GET","HEAD"]},"sitemap.pages":{"uri":"sitemap.xml\/pages","methods":["GET","HEAD"]},"rss.index":{"uri":"rss","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"rss.products":{"uri":"rss-products","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"rss.posts":{"uri":"rss-posts","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"all":{"uri":"{all}","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"],"wheres":{"all":".*"}},"passport.token":{"uri":"oauth\/token","methods":["POST"]},"passport.authorizations.authorize":{"uri":"oauth\/authorize","methods":["GET","HEAD"]},"passport.token.refresh":{"uri":"oauth\/token\/refresh","methods":["POST"]},"passport.authorizations.approve":{"uri":"oauth\/authorize","methods":["POST"]},"passport.authorizations.deny":{"uri":"oauth\/authorize","methods":["DELETE"]},"passport.tokens.index":{"uri":"oauth\/tokens","methods":["GET","HEAD"]},"passport.tokens.destroy":{"uri":"oauth\/tokens\/{token_id}","methods":["DELETE"]},"passport.clients.index":{"uri":"oauth\/clients","methods":["GET","HEAD"]},"passport.clients.store":{"uri":"oauth\/clients","methods":["POST"]},"passport.clients.update":{"uri":"oauth\/clients\/{client_id}","methods":["PUT"]},"passport.clients.destroy":{"uri":"oauth\/clients\/{client_id}","methods":["DELETE"]},"passport.scopes.index":{"uri":"oauth\/scopes","methods":["GET","HEAD"]},"passport.personal.tokens.index":{"uri":"oauth\/personal-access-tokens","methods":["GET","HEAD"]},"passport.personal.tokens.store":{"uri":"oauth\/personal-access-tokens","methods":["POST"]},"passport.personal.tokens.destroy":{"uri":"oauth\/personal-access-tokens\/{token_id}","methods":["DELETE"]},"sanctum.csrf-cookie":{"uri":"sanctum\/csrf-cookie","methods":["GET","HEAD"]}}};
...
mw.askusertostay = false;
  ...
  mw.require = function(url, inHead, key, defered) {
    ...
    var t = url.split('.').pop();
    url = url.contains('//') ? url : (t !== "css" ? "http://127.0.0.1:8000/userfiles/modules/microweber/api/" + url  :  "http://127.0.0.1:8000/userfiles/modules/microweber/css/" + url);
...
mw.required.push("http://127.0.0.1:8000/userfiles/modules/microweber/api/jquery.js");



mw.required.push("http://127.0.0.1:8000/userfiles/modules/microweber/api/tools.js");
mw.required.push("http://127.0.0.1:8000/userfiles/modules/microweber/api/tools/cookie.js");



mw.required.push("http://127.0.0.1:8000/userfiles/modules/microweber/api/forms.js");

mw.required.push("http://127.0.0.1:8000/userfiles/modules/microweber/api/url.js");

mw.required.push("http://127.0.0.1:8000/userfiles/modules/microweber/api/events.js");

//mw.required.push("http://127.0.0.1:8000/userfiles/modules/microweber/api/upgrades.js");
mw.required.push("http://127.0.0.1:8000/userfiles/modules/microweber/api/session.js");

mw.required.push("http://127.0.0.1:8000/userfiles/modules/microweber/api/shop.js");

mw.required.push("http://127.0.0.1:8000/userfiles/modules/microweber/api/common.js");

mw.required.push("http://127.0.0.1:8000/userfiles/modules/microweber/api/components.js");

mw.required.push("http://127.0.0.1:8000/userfiles/modules/microweber/api/dialog.js");
mw.required.push("http://127.0.0.1:8000/userfiles/modules/microweber/api/instruments.js");
mw.required.push("http://127.0.0.1:8000/userfiles/modules/microweber/api/forms.js");
mw.required.push("http://127.0.0.1:8000/userfiles/modules/microweber/api/fonts.js");
mw.required.push("http://127.0.0.1:8000/userfiles/modules/microweber/api/animations.js");
mw.required.push("http://127.0.0.1:8000/userfiles/modules/microweber/api/background_videos.js");

//mw.required.push("http://127.0.0.1:8000/userfiles/modules/microweber/api/content.js");
...
mw.required.push('http://127.0.0.1:8000/userfiles/modules/microweber/api/tools/base64.js');
...
mw.required.push('http://127.0.0.1:8000/userfiles/modules/microweber/api/tools/checkbox.js');
...
mw.required.push('http://127.0.0.1:8000/userfiles/modules/microweber/api/tools/colorpicker.js');
...
mw.required.push('http://127.0.0.1:8000/userfiles/modules/microweber/api/tools/common-extend.js');
...
mw.required.push('http://127.0.0.1:8000/userfiles/modules/microweber/api/tools/common.js');
...
mw.required.push('http://127.0.0.1:8000/userfiles/modules/microweber/api/tools/dialog.js');
...
mw.required.push('http://127.0.0.1:8000/userfiles/modules/microweber/api/tools/domhelpers.js');
...
mw.required.push('http://127.0.0.1:8000/userfiles/modules/microweber/api/tools/dropdown.js');
...
mw.required.push('http://127.0.0.1:8000/userfiles/modules/microweber/api/tools/editor.js');
...
mw.required.push('http://127.0.0.1:8000/userfiles/modules/microweber/api/tools/element.js');
...
mw.required.push('http://127.0.0.1:8000/userfiles/modules/microweber/api/tools/elementedit.js');
...
mw.required.push('http://127.0.0.1:8000/userfiles/modules/microweber/api/tools/external.js');
...
mw.required.push('http://127.0.0.1:8000/userfiles/modules/microweber/api/tools/extradata-form.js');
...
mw.required.push('http://127.0.0.1:8000/userfiles/modules/microweber/api/tools/fullscreen.js');
...
mw.required.push('http://127.0.0.1:8000/userfiles/modules/microweber/api/tools/gallery.js');
...
mw.required.push('http://127.0.0.1:8000/userfiles/modules/microweber/api/tools/helpers.js');
...
mw.required.push('http://127.0.0.1:8000/userfiles/modules/microweber/api/tools/iframe-tools.js');
...
mw.required.push('http://127.0.0.1:8000/userfiles/modules/microweber/api/tools/images.js');
...
mw.required.push('http://127.0.0.1:8000/userfiles/modules/microweber/api/tools/jquery.tools.js');
...
mw.required.push('http://127.0.0.1:8000/userfiles/modules/microweber/api/tools/loading.js');
...
mw.required.push('http://127.0.0.1:8000/userfiles/modules/microweber/api/tools/loops.js');
...
mw.required.push('http://127.0.0.1:8000/userfiles/modules/microweber/api/tools/modules-dialogs.js');
...
mw.required.push('http://127.0.0.1:8000/userfiles/modules/microweber/api/tools/native-notification.js');
...
mw.required.push('http://127.0.0.1:8000/userfiles/modules/microweber/api/tools/notification.js');
...
mw.required.push('http://127.0.0.1:8000/userfiles/modules/microweber/api/tools/objects.js');
...
mw.required.push('http://127.0.0.1:8000/userfiles/modules/microweber/api/tools/responsive.js');
...
mw.required.push('http://127.0.0.1:8000/userfiles/modules/microweber/api/tools/select.js');
...
mw.required.push('http://127.0.0.1:8000/userfiles/modules/microweber/api/tools/spinner.js');
...
mw.required.push('http://127.0.0.1:8000/userfiles/modules/microweber/api/tools/storage.js');
...
mw.required.push('http://127.0.0.1:8000/userfiles/modules/microweber/api/tools/system-dialogs.js');
...
mw.required.push('http://127.0.0.1:8000/userfiles/modules/microweber/api/tools/tabs.js');
...
mw.required.push('http://127.0.0.1:8000/userfiles/modules/microweber/api/tools/tooltip.js');
...
mw.required.push('http://127.0.0.1:8000/userfiles/modules/microweber/api/tools/uiaccordion.js');
