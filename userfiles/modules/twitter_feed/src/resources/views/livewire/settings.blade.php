...
showMainEditTab: 'mainSettings'
    ...
    <div x-show="showMainEditTab=='mainSettings'" x-transition:enter="tab-pane-slide-left-active">
        ...
        <div>
            ...
            <livewire:piksera-option::text  placeholder="Example: technology" optionKey="search_string" :optionGroup="$moduleId" :module="$moduleType"  />
        </div>
        ...
        <div class="mt-3">
            ...
            <livewire:piksera-option::numeric optionKey="number_of_items" :optionGroup="$moduleId" :module="$moduleType"  />
        </div>
        ...
        <div class="pt-3" style="display: none;" id="toggle-advanced-settings-twitter">
            ...
            <div class="mt-3">
                ...
                <livewire:piksera-option::text optionKey="consumer_key" :optionGroup="$moduleId" :module="$moduleType"  />
            </div>
            ...
            <div class="mt-3">
                ...
                <livewire:piksera-option::text optionKey="consumer_secret" :optionGroup="$moduleId" :module="$moduleType"  />
            </div>
            ...
            <div class="mt-3">
                ...
                <livewire:piksera-option::text optionKey="access_token" :optionGroup="$moduleId" :module="$moduleType"  />
            </div>
            ...
            <div class="mt-3">
                ...
                <livewire:piksera-option::text optionKey="access_token_secret" :optionGroup="$moduleId" :module="$moduleType"  />
            </div>
