<div>
    ...
    <livewire:piksera-option::file-picker  allowedType="audio"  optionKey="data-audio-upload" :optionGroup="$moduleId" :module="$moduleType"  />
</div>
...
<div class="mt-3">
    ...
    <livewire:piksera-option::textarea optionKey="data-audio-url" :optionGroup="$moduleId" :module="$moduleType"  />
</div>
