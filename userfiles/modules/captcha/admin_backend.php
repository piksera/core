                ...
                <div class="<?php print $config['module_class'] ?>">
                    <div class="form-group">
                        ...
                        <select class="mw_option_field js-select-captcha-provider  form-select" data-width="100%" name="provider" option-group="captcha">
                            <option value="piksera"><?php _e("Select"); ?></option>
                            ...
                            <option value="piksera" <?php if (get_option('provider', 'captcha') == 'piksera'): ?>selected="selected"<?php endif; ?>><?php _e("Captcha"); ?></option>
                        </select>
