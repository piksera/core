...
showMainEditTab: 'video'
    ...
    >
        ...
        <div class="mt-3">
            ...
            <livewire:piksera-option::textarea optionKey="embed_url" :optionGroup="$moduleId" :module="$moduleType"  />
        </div>

        <div class="mt-3">
            <label class="live-edit-label">{{__('Upload Video')}} </label>
            <livewire:piksera-option::file-picker allowedType="video" optionKey="upload" :optionGroup="$moduleId" :module="$moduleType"  />
        </div>
    ...
    <div x-show="showMainEditTab=='settings'" x-transition:enter="tab-pane-slide-left-active">
        ...
        <div class="d-flex gap-3 w-full">
            <div class="mt-3">
                ...
                <livewire:piksera-option::text optionKey="width" :optionGroup="$moduleId" :module="$moduleType"  />
            </div>

            <div class="mt-3">
                <label class="live-edit-label">{{__('Height')}} </label>
                <livewire:piksera-option::text optionKey="height" :optionGroup="$moduleId" :module="$moduleType"  />
            </div>
        </div>
        ...
        <div class="d-flex gap-3 w-full mt-3">
            <div>
                ...
                <livewire:piksera-option::toggle optionKey="autoplay" :optionGroup="$moduleId" :module="$moduleType"  />
            </div>

            <div>
                <label class="live-edit-label">{{__('Loop')}} </label>
                <livewire:piksera-option::toggle optionKey="loop" :optionGroup="$moduleId" :module="$moduleType"  />
            </div>

            <div>
                <label class="live-edit-label">{{__('Muted')}} </label>
                <livewire:piksera-option::toggle optionKey="muted" :optionGroup="$moduleId" :module="$moduleType"  />
            </div>
        </div>
        <div class="d-flex gap-3 w-full mt-3">
            <div>
                <label class="live-edit-label">{{__('Hide Controls')}} </label>
                <livewire:piksera-option::toggle optionKey="hide_controls" :optionGroup="$moduleId" :module="$moduleType"  />
            </div>

            <div>
                <label class="live-edit-label">{{__('Lazy load')}} </label>
                <livewire:piksera-option::toggle optionKey="lazyload" :optionGroup="$moduleId" :module="$moduleType"  />
            </div>
        </div>

        <div class="mt-3">
            <label class="live-edit-label">{{__('Thumbnail')}} </label>
            <livewire:piksera-option::media-picker optionKey="upload_thumb" :optionGroup="$moduleId" :module="$moduleType"  />
        </div>
    ...
    @if($moduleTemplates && count($moduleTemplates) >  1)
        ...
        <div x-show="showMainEditTab=='design'" x-transition:enter="tab-pane-slide-right-active">
            ...
            <div>
                <livewire:piksera-live-edit::module-select-template
