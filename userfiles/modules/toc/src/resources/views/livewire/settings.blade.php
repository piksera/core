    ...
    @endif
        ...
        <div x-show="showMainEditTab=='mainSettings'">
            ...
            <div>
                ...
                <livewire:piksera-option::text optionKey="headers" :optionGroup="$moduleId" :module="$moduleType"  />
                <label>
            ...
            <div class="mt-3">
                <livewire:piksera-option::range-slider label="{{__('Scroll Speed')}}" min="10" max="200" unit="px" optionKey="speed" :optionGroup="$moduleId" :module="$moduleType"  />
            </div>
