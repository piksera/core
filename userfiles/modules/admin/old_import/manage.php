...
<div id="backups_list" >
  ...
  <table   cellspacing="0" cellpadding="0" class="mw-ui-table">
    ...
    <tbody>
      <?php
      $backups = false;// mw('Piksera\Utils\Import')->get();
      if(isarr($backups )): ?>
      <?php
	  $i = 1;
      ...
      <tr class="mw_admin_import_item_<?php print $i ?>">
        <td><?php print $item['filename']  ?></td>
          ...
          <td><a class="show-on-hover mw-ui-btn mw-ui-btn-blue" target="_blank" href="<?php print api_url('Piksera/Utils/Import/download'); ?>?file=<?php print $item['filename']  ?>"><?php _e("Download"); ?></a></td>
        <td>
