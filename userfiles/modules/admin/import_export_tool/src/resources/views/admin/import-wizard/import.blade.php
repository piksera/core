                    ...
                    <td>
                        ...
                        <select class="form-control" wire:model="import_feed.primary_key" id="feed_primary_key">
                            ...
                            @if ($this->import_feed['import_to'] == 'products')
                                ...
                                @php
                                    $findContentData = \PikseraPackages\ContentData\Models\ContentData::groupBy('field_name')->get();
                                    $dbFields = [];
                                    if (!empty($findContentData)) {
                                        foreach ($findContentData as $field) {
                                            if (array_key_exists($field->field_name, \PikseraPackages\Product\Models\Product::$contentDataDefault)) {
                                                continue;
                                            }
                ...
                <tr>
                    ...
                    <td>
                        ...
                        if (isset($import_feed['count_of_contents'])) {
                            $recomendedSipltToParts = \PikseraPackages\Export\SessionStepper::recomendedSteps($import_feed['count_of_contents']);
                        }
                        @endphp
