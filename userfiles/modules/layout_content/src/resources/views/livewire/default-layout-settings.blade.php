<div class="mt-3 mb-3" x-data="{showSettings: 'main'}">
    ...
    <div x-show="showSettings == 'title'" x-transition:enter="tab-pane-slide-right-active">
        <div class="mt-4 mb-3">
            ...
            <livewire:piksera-option::text optionKey="title" :optionGroup="$moduleId" :module="$moduleType"  />
        </div>

        <div class="mt-4 mb-3">
            <label class="live-edit-label">{{__('Description')}}</label>
            <livewire:piksera-option::simple-text-editor optionKey="description" :optionGroup="$moduleId" :module="$moduleType"  />
        </div>
    </div>
    ...
    <div x-show="showSettings == 'button'" x-transition:enter="tab-pane-slide-right-active">
        <div class="mt-4 mb-3">
            ...
            <livewire:piksera-option::text optionKey="buttonText" :optionGroup="$moduleId" :module="$moduleType"  />
        </div>

        <div class="mt-4 mb-3">
            <label class="live-edit-label">{{__('Button Link')}}</label>
            <livewire:piksera-option::text optionKey="buttonLink" :optionGroup="$moduleId" :module="$moduleType"  />
        </div>
    </div>
    ...
    <div x-show="showSettings == 'main'" x-transition:enter="tab-pane-slide-right-active">
        ...
        <div class="mt-4 mb-3">
            ...
            <livewire:piksera-option::radio-modern :options="$alignOptions" optionKey="align" :optionGroup="$moduleId" :module="$moduleType"  />
        </div>

        <div class="mt-4 mb-3">
            <livewire:piksera-option::range-slider min="1" max="6" label="Max Columns"
