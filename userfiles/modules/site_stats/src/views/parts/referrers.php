...
<?php foreach ($data as $item): ?>
    ...
    if (isset($item['referrer_domain_id']) and isset($item['referrer_domain']) and $item['referrer_domain_id'] != null) {
        ...
        $referrerIcon = '<img class="icon" src="https://favicon.pikseraapi.com/' . $referrer . '" alt="">';
    } else {
    ...
    ?>
        ...
        <div class="collapse" id="refferers-show-more<?php print $item['id'] ?>">
            ...
            <div class="d-flex align-items-center justify-content-between" href="https://templates.piksera.com/mw/admin/shop/product ">
