...
namespace PikseraPackages\Modules\SiteStats;


use PikseraPackages\Modules\SiteStats\Models\Browsers;
use PikseraPackages\Modules\SiteStats\Models\Geoip;
use PikseraPackages\Modules\SiteStats\Models\Log;
use PikseraPackages\Modules\SiteStats\Models\Referrers;
use PikseraPackages\Modules\SiteStats\Models\ReferrersDomains;
use PikseraPackages\Modules\SiteStats\Models\ReferrersPaths;
use PikseraPackages\Modules\SiteStats\Models\Sessions;
use PikseraPackages\Modules\SiteStats\Models\StatsUrl;
...
class Tracker
{
    ...
    private function __parse_geo_ip_country($ip)
    {
        ...
        $mmdb = normalize_path(dirname(PS_PATH) . 'Utils/ThirdPartyLibs/geoip_lite/GeoLite2-Country.mmdb', false);
