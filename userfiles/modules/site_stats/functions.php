...
//    }
//
//    $tracker = new PikseraPackages\Modules\SiteStats\Tracker();
//
...
//    }
    ...
    event(new \PikseraPackages\Modules\SiteStats\Events\PingStatsEvent([
        'referer'=>$referer,
    ]));
...
{
    return (new \PikseraPackages\Modules\SiteStats\Models\ContentViewCounter)->getCountViewsForContent($content_id);
}
