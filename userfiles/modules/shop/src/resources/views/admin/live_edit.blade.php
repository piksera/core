           ...
           <div class=" ">
               ...
               <div class="tab-content py-3">
                   ...
                   <div class="tab-pane fade" id="settings">
                       <livewire:piksera-module-shop::shop-settings :moduleId="$moduleId" moduleType="shop" />
                   </div>

                  <div class="tab-pane fade" id="templates">

                      <livewire:piksera-live-edit::module-select-template :moduleId="$moduleId" moduleType="shop" />
