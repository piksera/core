...
use PikseraPackages\Modules\Shop\Http\Livewire\Traits\ShopCategoriesTrait;
use PikseraPackages\Modules\Shop\Http\Livewire\Traits\ShopCustomFieldsTrait;
use PikseraPackages\Modules\Shop\Http\Livewire\Traits\ShopTagsTrait;
use PikseraPackages\Page\Models\Page;
use PikseraPackages\Product\Models\Product;
use PikseraPackages\Option\Models\ModuleOption;
...
class ShopComponent extends Component
{
    ...
    public function render()
    {
        ...
        if (empty($this->moduleTemplateNamespace)) {
            $this->moduleTemplateNamespace = 'piksera-module-shop::livewire.shop.index';
        }
