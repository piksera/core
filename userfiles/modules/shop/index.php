<?php
//$controller = \Illuminate\Support\Facades\App::make(\PikseraPackages\Shop\Http\Controllers\ShopController::class);
//
...
if (isset($params['template'])) {
    $livewireModuleBladeView = 'piksera-module-shop::livewire.shop.' . $params['template'];
...
// THE NEW SHOP
echo view('piksera-module-shop::render-livewire-shop', [
    'moduleId' => $params['id'],
    'moduleType' => 'shop',
