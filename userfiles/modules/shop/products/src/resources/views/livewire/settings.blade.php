    ...
    showEditTab: 'content'
        ...
        <div x-show="showEditTab=='settings'">
            ...
            <div>
                ...
                <livewire:piksera-option::select-page optionKey="data-page-id" :optionGroup="$moduleId" :module="$moduleType"  />
            </div>

            <div>
                <label class="live-edit-label">Filter Tags</label>
                <livewire:piksera-option::select-tags optionKey="data-tags" :optionGroup="$moduleId" :module="$moduleType"  />
            </div>
            ...
            <div class="mb-3">
                ...
                @endphp
                <livewire:piksera-option::radio :radioOptions="$radioOptions" optionKey="data-show" :optionGroup="$moduleId" :module="$moduleType"  />
            </div>
            ...
            <div
                ...
                <div
                    ...
                    <div class="mb-3">
                        <livewire:piksera-option::checkbox-single optionName="Thumbnail" optionKey="data-show-thumbnail" :optionGroup="$moduleId" :module="$moduleType"  />
                    </div>

                    <div class="mb-3">
                        <div class="w-full">
                            <livewire:piksera-option::checkbox-single optionName="Title" optionKey="data-show-title" :optionGroup="$moduleId" :module="$moduleType"  />
                        </div>
                        <div class="w-full" x-show="showTitle">
                            <label class="live-edit-label">{{__('Title Limit')}} </label>
                            <livewire:piksera-option::text type="number" optionKey="data-title-limit" :optionGroup="$moduleId" :module="$moduleType"  />
                        </div>
                    </div>

                    <div class="mb-3">
                        <div class="w-full">
                            <livewire:piksera-option::checkbox-single optionName="Description" optionKey="data-show-description" :optionGroup="$moduleId" :module="$moduleType"  />
                        </div>
                        <div class="w-full" x-show="showDescription">
                            <label class="live-edit-label">{{__('Description Limit')}} </label>
                            <livewire:piksera-option::text type="number" optionKey="data-character-limit" :optionGroup="$moduleId" :module="$moduleType"  />
                        </div>
                    </div>

                    <div class="mb-3">
                        <div class="w-full">
                            <livewire:piksera-option::checkbox-single optionName="Read More" optionKey="data-show-read-more" :optionGroup="$moduleId" :module="$moduleType"  />
                        </div>
                        <div class="w-full" x-show="showReadMore">
                            <label class="live-edit-label">{{__('Read more text')}} </label>
                            <livewire:piksera-option::text optionKey="data-read-more-text" :optionGroup="$moduleId" :module="$moduleType"  />
                        </div>
                    </div>

                    <div class="mb-3">
                        <div class="w-full">
                            <livewire:piksera-option::checkbox-single optionName="Created At" optionKey="data-show-date" :optionGroup="$moduleId" :module="$moduleType"  />
                        </div>
                    </div>
                </div>
                ...
                <div class="w-full row">
                    ...
                    <div class="col-md-6">
                        ...
                        <livewire:piksera-option::text type="number" optionKey="data-limit" :optionGroup="$moduleId" :module="$moduleType"  />
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        @endphp
                        <livewire:piksera-option::dropdown :dropdownOptions="$radioOptions" optionKey="data-order-by" :optionGroup="$moduleId" :module="$moduleType"  />
                    </div>
