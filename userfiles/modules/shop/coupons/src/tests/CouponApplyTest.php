...
namespace PikseraPackages\Modules\Shop\Coupons\tests;


use PikseraPackages\Checkout\CheckoutManager;
use PikseraPackages\Core\tests\TestCase;
use PikseraPackages\Modules\Shop\Coupons\Models\CartCouponLog;
use PikseraPackages\Shop\tests\ShopTestHelperTrait;
use PikseraPackages\Tax\Models\TaxType;
...
class CouponApplyTest extends TestCase
{
    ...
    public function testValidCouponCode()
    {
        ...
        $checkoutDetails['email'] = 'test1'.uniqid().'@piksera.com';
    ...
    public function testValidCouponCodeWithTooBigDiscount()
    {
        ...
        $checkoutDetails = array();
        $checkoutDetails['email'] = 'test'.uniqid().'@piksera.com';
        $checkoutDetails['first_name'] = 'Client';
        $checkoutDetails['last_name'] = 'Piksera';
