...
namespace PikseraPackages\Modules\ContactForm\tests\Browser;
...
<module type="contact_form" id="'.$moduleIdRand.'" template="default" default-fields="'.$fields.'" button-text="Send me some forms" /></div>',
       ...
       save_option(array(
        ...
        $this->browse(function (Browser $browser) use ($siteUrl,$moduleIdRand) {
            ...
            $browser->type('e-mail-address', 'bobi' . $uniqueId . '@piksera.com');
            $browser->type('phone', $uniqueId);
            $browser->type('company', 'Piksera ORG' . $uniqueId);
         ...
         //   $browser->assertSee('Your message successfully sent');
            ...
            $findFormDataValues = FormDataValue::where('field_value', 'bobi' . $uniqueId . '@piksera.com')->get();
            ...
            $this->assertEquals($formDataValuesMap['company']['field_value'], 'Piksera ORG' . $uniqueId);
            ...
            $this->assertEquals($formDataValuesMap['e-mail-address']['field_value'], 'bobi' . $uniqueId . '@piksera.com');
