                ...
                <div class=" pt-0">
                    ...
                    <div class="">
                        ...
                        <div class="form-group mb-4">
                            <?php $emailAutorespondEnable = \PikseraPackages\Option\Facades\Option::getValue('email_autorespond_enable', $mod_id); ?>
...
-->
                            ...
                            <div class="alert alert-primary auto-respond-custom-sender">
                                ...
                                <div class="form-group mb-4">
                                    <?php $emailAutorespondCustomSender = \PikseraPackages\Option\Facades\Option::getValue('email_autorespond_custom_sender', $mod_id); ?>
                                    <div class="form-check form-switch pl-0">
            ...
            <div class="tab-pane fade tab-pane-slide-right" id="tabs-nav-tab-manage-contact-receivers" role="tabpanel">
               <div class="d-flex align-items-center mb-3">
                ...
                <div class="pt-0">
                    ...
                    <div class="form-group mb-4">
                        <?php $emailCustomReceivers = \PikseraPackages\Option\Facades\Option::getValue('email_custom_receivers', $mod_id); ?>
                        <div class="form-check form-switch pl-0">
