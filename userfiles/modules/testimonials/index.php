...
$testimonialsQuery = \PikseraPackages\Modules\Testimonials\Models\Testimonial::query();
    ...
    if (!$isDefaultContentApplied) {
        ...
        if (isset($defaultTestimonials['testimonials'])) {
            foreach ($defaultTestimonials['testimonials'] as $defaultTestimonial) {
                $testimonial = new \PikseraPackages\Modules\Testimonials\Models\Testimonial();
