...
>
    ...
    <div x-show="openProjects" class="form-control-live-edit-label-wrapper">
        ...
        <div>
            <x-piksera-ui::input wire:model="search" placeholder="Search group..." />
        </div>
    ...
    <x-piksera-ui::dialog-modal wire:key="addNewProjectModal" wire:model="addNewProjectModal">
        <x-slot name="title">
            Add new group
        </x-slot>
        ...
        <x-slot name="content">
            ...
            <x-piksera-ui::input type="text" wire:model="newProjectName" />
        </x-slot>

        <x-slot name="footer">
            <x-piksera-ui::secondary-button wire:click="closeProjectModal" wire:loading.attr="disabled">
                {{ __('Cancel') }}
            </x-piksera-ui::secondary-button>

            <x-piksera-ui::primary-button class="ms-2" wire:click="saveNewProject" wire:loading.attr="disabled">
