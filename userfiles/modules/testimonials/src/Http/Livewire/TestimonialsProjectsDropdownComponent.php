...
namespace PikseraPackages\Modules\Testimonials\Http\Livewire;

use PikseraPackages\Module\Http\Livewire\Admin\ModuleOption\OptionElement;
use PikseraPackages\Modules\Testimonials\Models\Testimonial;
...
class TestimonialsProjectsDropdownComponent extends OptionElement
{
    ...
    public string $view = 'piksera-module-testimonials::livewire.projects-dropdown';
