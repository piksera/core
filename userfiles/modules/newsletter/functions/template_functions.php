...
function newsletter_get_template($data) {
    ...
    $findNewsletterTemplate = \PikseraPackages\Modules\Newsletter\Models\NewsletterTemplate::where('id', $data['id'])->first();
...
function newsletter_get_templates() {
    ...
    $getTemplates = \PikseraPackages\Modules\Newsletter\Models\NewsletterTemplate::query();
