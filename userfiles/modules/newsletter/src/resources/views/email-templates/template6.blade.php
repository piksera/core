                            ...
                            <tr>
                                <td align="left" style=" padding:10px 25px;word-break:break-word;">
                                    ...
                                    <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:22px;text-align:left;color:#555;">
                                        Hello {{ name }}!<br></br>
                                        Thank you for signing up for  Piksera. We're really happy to have you! Click the link below to login to your account:
                                    </div>
                            ...
                            <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    ...
                                    <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:14px;line-height:20px;text-align:left;color:#525252;">
                                        ...
                                        <a href="https://www.piksera.com" style="color:#2F67F6">piksera.com</a>
                                    </div>
