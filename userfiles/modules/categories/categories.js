(function (){
    ...
    var PikseraManager = function (service, provider, defaultService, defaultProvider) {
        var scope = this;
        var Provider;
    ...
    var pikseraManager = function (data) {
        return new PikseraManager(data.service, data.provider, data.defaultService, data.defaultProvider);
    };

    var CategoryManager = function (service, provider) {
        return pikseraManager({
            service: service,
            provider: provider,
