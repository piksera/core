        ...
        <div x-show="showEditTab=='content'">
            ...
            <script type="text/javascript">
                ...
                <div class="mt-1">
                    ...
                    <livewire:piksera-option::toggle optionKey="single-only" :optionGroup="$moduleId" :module="$moduleType"  />
                </div>

                <div class="mt-1">
                    <label class="live-edit-label">{{__('Show sub categories')}} </label>
                    <livewire:piksera-option::toggle optionKey="show-subcats" :optionGroup="$moduleId" :module="$moduleType"  />
                </div>

                <div class="mt-1">
                    <label class="live-edit-label">{{__('Hide pages')}} </label>
                    <livewire:piksera-option::toggle optionKey="hide-pages" :optionGroup="$moduleId" :module="$moduleType"  />
                </div>

                <div class="mt-1">
                    <label class="live-edit-label">{{__('Show only products in stock')}} </label>
                    <livewire:piksera-option::toggle optionKey="filter-only-in-stock" :optionGroup="$moduleId" :module="$moduleType"  />
                </div>
