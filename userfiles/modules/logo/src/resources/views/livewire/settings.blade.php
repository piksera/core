    ...
    <div>
        ...
        <div x-data="{'logoType': '{{$logoType}}'}" class="card-body" style="padding:5px;padding-bottom:25px;">
            ...
            <div>
                ...
                @endphp
                <livewire:piksera-option::radio-modern :options="$logoTypeOptions" optionKey="logotype" :optionGroup="$moduleId" :module="$moduleType"  />
            </div>
            ...
            <div x-show="logoType == 'image'">
                <div>
                    ...
                    <div class=form-control-live-edit-label-wrapper"">
                        ...
                        <livewire:piksera-option::media-picker optionKey="logoimage" :optionGroup="$moduleId" :module="$moduleType"  />
                    </div>
                </div>

                <div>
                    <livewire:piksera-option::range-slider labelUnit="px" min="100" max="500" label="Logo Image - Size" optionKey="size" :optionGroup="$moduleId" :module="$moduleType"  />
                </div>
                ...
                @if (isset($moduleParams['data-alt-logo']))
                 <div>
                        ...
                        <livewire:piksera-option::media-picker optionKey="logoimage_inverse" :optionGroup="$moduleId" :module="$moduleType"  />
                    </div>
                @endif
            </div>
            ...
            <div x-show="logoType == 'text'">
                ...
                <div class="mt-3">
                    <livewire:piksera-option::color-picker label="Logo text color" optionKey="text_color" :optionGroup="$moduleId" :module="$moduleType"  />
                </div>

                <div class="mt-3">
                    <livewire:piksera-option::range-slider labelUnit="px" min="10" max="68" label="Logo Text - Size" optionKey="font_size" :optionGroup="$moduleId" :module="$moduleType"  />
                </div>
            </div>
