    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-xl-3 mb-xl-0 mb-3">
                <h5 class="font-weight-bold settings-title-inside"><?php _e("Powered by Piksera"); ?></h5>
                <small class="text-muted"><?php _e('Control whether or not "Powered by Piksera" links display in the footer of your site and products'); ?>.</small>
