...
showEditTab: 'main'
    ...
    <div x-show="showEditTab=='main'" x-transition:enter="tab-pane-slide-left-active">
        ...
        <div>
        <livewire:piksera-live-edit::module-items-editor :moduleId="$moduleId" :moduleType="$moduleType"
        ...
        <div x-show="showEditTab=='design'" x-transition:enter="tab-pane-slide-right-active">
            ...
            <div>
                <div class="d-flex col-xl-3 col-md-6 col-12">
                    ...
                    <livewire:piksera-option::toggle value="1" optionKey="use_content_from_live_edit" :optionGroup="$moduleId" :module="$moduleType" />
                    <div>
