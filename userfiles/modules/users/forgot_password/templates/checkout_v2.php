                ...
                <div class="clearfix">
                    ...
                    <div class="form-group">
                        ...
                        <?php if (!isset($form_title) or $form_title == false): ?>
                            <?php _lang("Enter your username or email", "templates/bloggy"); ?>
                        <?php else: ?>
                        ...
                        <div class="input-group mb-0">
                            ...
                            <input required="" type="text" class="form-control" placeholder="<?php _lang("Email or username", "templates/bloggy"); ?>" name="username">
                        </div>
                        <b class="tooltip tooltip-bottom-right">"<?php _lang("Needed to verify your account", "templates/bloggy"); ?></b>
                    </div>
