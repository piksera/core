...
use PikseraPackages\Country\Models\Country;
...
if ($findCustomer) {
    $findAddressBilling = \PikseraPackages\Customer\Models\Address::where('type', 'billing')->where('customer_id', $findCustomer->id)->first();
...
$countries = [];
$getCountries = \PikseraPackages\Country\Models\Country::all();
