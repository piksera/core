        ...
        <div id="user_login_holder_checkout_v2">
            ...
            <form method="post" id="user_login_checkout_v2" class="clearfix">
                ...
                <div class="social-login">
                    ...
                    $mw_login = get_option('enable_user_piksera_registration', 'users') == 'y';
                    ...
                    <ul>
                        ...
                        <?php endif; ?>
                        <?php if ($mw_login): ?>
                            <li><a href="<?php print api_link('user_social_login?provider=piksera') ?>" class="mw-signin-with-piksera">Piksera login</a></li>
                        <?php endif; ?>
                        <?php if ($have_social_login){ ?>
                    </ul>
                <?php } ?>
