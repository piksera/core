...
$piksera_login = get_option('enable_user_piksera_registration', 'users') == 'y';
   ...
   <div class="col-lg-10">
       ...
       <div class="card card-md">
           <div class="card-body pb-3" id="admin_login">
               ...
               <?php else: ?>
                   <?php if ($piksera_login and get_option('piksera_app_id', 'users') != false and get_option('piksera_app_secret', 'users') != false): ?>
                   <?php endif; ?>
                   ...
                   <form autocomplete="on" method="post" id="user_login_<?php print $params['id'] ?>" action="<?php print api_link('user_login') ?>">
                       ...
                       if (\PikseraPackages\Multilanguage\MultilanguageHelpers::multilanguageIsEnabled()) {
                            $supportedLanguagesMultilang = \PikseraPackages\Multilanguage\MultilanguageHelpers::getSupportedLanguages();
