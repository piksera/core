        ...
        $(document).ready(function () {
            ...
            mw.$("#avatar_holder .mw-icon-close").click(function () {
                if (mw.$("#avatar_holder").length === 0) {
                    mw.$(".js-user-image").attr("src", '<?php print modules_url(); ?>piksera/api/libs/mw-ui/assets/img/no-user.png');
                            ...
                            <div class="d-inline-block">
                                <?php if ($data['thumbnail'] == '') { ?>
                                    <div class="img-circle-holder img-absolute js-img-holder">
                                        <img src="<?php print modules_url(); ?>piksera/api/libs/mw-ui/assets/img/no-user.png" class="js-user-image"/>
