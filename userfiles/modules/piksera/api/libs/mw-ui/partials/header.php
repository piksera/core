        ...
        <div class="d-flex justify-content-between align-items-center py-1">
            <ul class="nav">
                ...
                <li class="mx-1 logo d-none d-md-block">
                    <h5 class="text-white mr-3 d-flex align-items-center h-100"><img src="assets/img/logo.svg" alt="Piksera" style="width: 170px;"/></h5>
                </li>
            ...
            <ul class="nav">
                <!--                        <li class="mx-1 logo d-block d-md-none">
                                            <h5 class="text-white mr-md-3">
                                                <img src="assets/img/logo-mobile.svg" alt="Piksera" style="height: 40px;" />
                                            </h5>
                                        </li>-->
