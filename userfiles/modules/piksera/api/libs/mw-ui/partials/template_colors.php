...
<div class="color-scheme-options d-none-x">
    ...
    <script>
        ...
        function reload_main_css() {
            ...
            if (current.length == 0) {
                var append = '<link rel="stylesheet" id="main-css-style" href="<?php echo $site_url; ?>userfiles/modules/piksera/api/libs/mw-ui/grunt/plugins/ui/css/main.php">';
                window.parent.$('head').append(append);
            }

            window.parent.$('#main-css-style').attr("href", '<?php echo $site_url; ?>userfiles/modules/piksera/api/libs/mw-ui/grunt/plugins/ui/css/main.php' + "?id=" + new Date().getMilliseconds());
        }
