(function () {
    ...
    mw.settings.libs = {
        ...
        materialDesignIcons: [
            function () {
                mw.require(mw.settings.modules_url + 'piksera/css/fonts/materialdesignicons/css/materialdesignicons.min.css');
            }
        ],
        mw_icons_mind: [
            function () {
                mw.require(mw.settings.modules_url + 'piksera/css/fonts/mw-icons-mind/line/style.css');
                mw.require(mw.settings.modules_url + 'piksera/css/fonts/mw-icons-mind/solid/style.css');
            }
        ],
        uppy: [
            'uppy.min.js',
