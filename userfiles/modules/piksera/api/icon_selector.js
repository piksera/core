    ...
    var IconLoader = function (store) {
        ...
        var common = {
            'fontAwesome': {
                ...
                icons: function () {
                     return new Promise(function (resolve) {
                         $.get(mw.settings.modules_url + 'piksera/api/fa.icons.js',function (data) {
            ...
            'materialIcons': {
                ...
                icons: function () {
                    return new Promise(function (resolve) {
                        $.get(mw.settings.modules_url + 'piksera/api/material.icons.js',function (data) {
                            resolve(JSON.parse(data));
                        });
                    });
                },
            ...
            'iconsMindLine': {
                ...
                load:  mw.settings.modules_url + 'piksera/api/libs/mw-icons-mind/line/style.css',
                unload: function () {
            ...
            'iconsMindSolid': {
                ...
                load:  mw.settings.modules_url + 'piksera/api/libs/mw-icons-mind/solid/style.css',
                unload: function () {
            ...
            'materialDesignIcons': {
                ...
                load:  mw.settings.modules_url + 'piksera/css/fonts/materialdesignicons/css/materialdesignicons.min.css',
                unload: function () {
            ...
            'mwIcons': {
                ...
                icons: function () {
                    return new Promise(function (resolve) {
                        $.get(mw.settings.modules_url + 'piksera/api/piksera.icons.js',function (data) {
                            resolve(JSON.parse(data));
                        });
                    });
                },
