...
// MOVED TO src\PikseraPackages\View\Views\install.php
...
<html>
<head>
    <title><?php _e("Piksera installation"); ?></title>
    <meta charset="utf-8">
  ...
  if ($is_pdo_loaded == false) {
    ...
    <?php if ($check_pass == false): ?>
        <?php if (!empty($server_check_errors)): ?>
            ...
            <h4>
                <?php _e("There are some errors on your server that will prevent Piksera from working properly"); ?>
            </h4>
            <ol class="error">
        ...
        <form method="post" id="form_<?php print $rand; ?>" autocomplete="true">
            ...
            <div class="hr"></div>
                ...
                <div class="mw-ui-field-holder">
                    <label class="mw-ui-label">
                        <?php _e("Table prefix"); ?>
                        <span data-help="<?php _e("Change this If you want to install multiple instances of Piksera to this database. Only latin letters and numbers are allowed."); ?>"><span class="mw-icon-help-outline mwahi tip"></span></span></label>
