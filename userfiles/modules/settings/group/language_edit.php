...
<script type="text/javascript">
    ...
    function send_lang_form_to_piksera() {
        ...
        <div class="row">
            <div class="col-xl-3 mb-xl-0 mb-3">
                ...
                <div class="mb-3">
                    ...
                    <a href="https://piksera.org/go/translation_help"  target="_blank" class="btn btn-outline-primary btn-sm  mt-md-2 mt-0"><?php _e('Help with translation'); ?></a>
                </div>
                <?php endif; ?>
                ...
                <!--
                                <small class=""><?php /*_e('Help us improve Piksera'); */?></small>
                                <a href="javascript:;" onclick="send_lang_form_to_piksera()" class="btn btn-outline-primary btn-sm mt-2"><?php /*_e('Send us your translation'); */?></a>
                                -->
            </div>
            <div class="col-xl-9">
                <form id="language-form" class="lang-edit-form">
                    ...
                    <?php
                    $getNamespaces = \PikseraPackages\Translation\Models\TranslationKey::getNamespaces();
                    $namespaceGroups = [
                        'Global' => [],
                        'Modules' => [],
                        'Templates' => [],
