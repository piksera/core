...
$langs = \PikseraPackages\Translation\LanguageHelper::getLanguagesWithDefaultLocale();
$langs_ready = [];
...
<script>
    ...
    function openMultilangEditModal(action) {
        ...
        if (action == 'activate') {
            ...
            <?php else: ?>
            mw.admin.admin_package_manager.install_composer_package_by_package_name('piksera-modules/multilanguage', $(this).attr('vkey'), this);
            <?php endif; ?>
        }
    }
</script>
