...
<textarea name="trust_proxies" class="mw_option_field form-control" data-option-group="website" placeholder="127.0.0.1" rows="5"><?php print $trust_proxies; ?></textarea>
        <small class="text-muted">
            ...
            <?php _e("If you are using a proxy server, you can specify the IP address of the server here. This will allow Piksera to trust the proxy server and get the correct IP address of the visitor. Set 1 IP address per line"); ?>
