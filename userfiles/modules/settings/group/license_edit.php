<?php use PikseraPackages\ComposerClient\Client;
...
<?php
if(!$params['prefix']){
    $url = 'https://piksera.org/go/whitelabel';
} else {
    $url = 'https://piksera.org/go/market?prefix='.$params['prefix'];
}
if(isset($params['require_name'])) {
    ...
    if (!empty($item)) {
        $item = \PikseraPackages\Package\PikseraComposerPackage::format($item);
