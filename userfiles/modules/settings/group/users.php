...
$enable_user_piksera_registration = get_option('enable_user_piksera_registration', 'users');
...
if ($enable_user_piksera_registration == false) {
    $enable_user_piksera_registration = 'n';
}
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                   <div class="row">
                                                       ...
                                                       <div class="form-group">
                                                           <div class="custom-control custom-checkbox d-flex align-items-center">
                                                               <input type="checkbox" class="mw_option_field form-check-input" name="enable_user_piksera_registration" option-group="users" id="enable_user_piksera_registration" value="y" <?php if ($enable_user_piksera_registration == 'y'): ?>checked<?php endif; ?> data-bs-toggle="collapse" data-bs-target="#mw-login-settings">
                                                               <label class="custom-control-label ms-2 d-flex align-items-center" for="enable_user_piksera_registration"><i class="mdi mdi-piksera mdi-30px lh-1_0 me-2" style="font-size: 20px;"></i> <?php _e('Piksera login enabled?'); ?></label>
                                                           </div>
                                                       </div>
                                                        <div class="collapse <?php if ($enable_user_piksera_registration == 'y'): ?>show<?php endif; ?>" id="mw-login-settings">
                                                            <small class="d-block mb-1"><?php _e("Please enter your credentials for Piksera login server"); ?></small>
                                                            <?php
                                                            $piksera_app_url = get_option('piksera_app_url', 'users');
                                                            if (empty($piksera_app_url)) {
                                                                $piksera_app_url = 'https://mwlogin.com';
                                                            }
                                                            ?>

                                                            <div class="form-group mt-3">
                                                                <label><?php _e("Server URL"); ?></label>
                                                                <input name="piksera_app_url" class="mw_option_field form-control" type="text" option-group="users" value="<?php print $piksera_app_url; ?>"/>
                                                            </div>

                                                            <div class="form-group mt-3">
                                                                <label><?php _e("Client ID"); ?></label>
                                                                <input name="piksera_app_id" class="mw_option_field form-control" type="text" option-group="users" value="<?php print get_option('piksera_app_id', 'users'); ?>"/>
                                                            </div>

                                                            <div class="form-group">
                                                                <label><?php _e("Client secret"); ?></label>
                                                                <input name="piksera_app_secret" class="mw_option_field form-control" type="text" option-group="users" value="<?php print get_option('piksera_app_secret', 'users'); ?>"/>
                                                            </div>
                                                        </div>
                                                   </div>
                                                </div>
