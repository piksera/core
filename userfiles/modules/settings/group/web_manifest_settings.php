    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                $nomanifest_app_icon = modules_url() . 'piksera/api/libs/mw-ui/assets/img/no-image.svg';
                ...
                <div class="d-flex">
                    ...
                    <span class="tip mw-btn-icon" id="remove-manifest_app_icon-btn"   data-bs-toggle="tooltip" aria-label="Clear manifest_app_icon" data-bs-original-title="Clear manifest_app_icon">
                                                <img src="<?php print modules_url()?>/piksera/api/libs/mw-ui/assets/img/trash.svg" alt="">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                $nofavicon = modules_url() . 'piksera/api/libs/mw-ui/assets/img/no-image.svg';
                if (!$maskable_icon) {
