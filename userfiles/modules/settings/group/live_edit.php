...
<div class="<?php print $config['module_class'] ?>">
    <div class="form-group">
        ...
        <select name="disable_keyboard_shortcuts" class="mw_option_field form-select" data-width="100%" option-group="website">
    ...
    <?php $enabled_custom_fonts = \PikseraPackages\Utils\Misc\GoogleFonts::getEnabledFonts(); ?>
</div>
