...
$system_cache_adapter = Config::get('piksera.cache_adapter');
$compile_assets = Config::get('piksera.compile_assets');
$force_https = Config::get('piksera.force_https');
$update_channel = Config::get('piksera.update_channel');
$developer_mode = Config::get('piksera.developer_mode');
...
$enabled_custom_fonts = \PikseraPackages\Utils\Misc\GoogleFonts::getEnabledFonts();
...
<div id="sysconfig-form-<?php print $params['id'] ?>" onSubmit="return save_sysconf_form();" autocomplete="off">
    ...
    /*   <div class="form-group">
        ...
        <select name="piksera[cache_adapter]" class="form-select" data-width="100%">
    ...
    <div class="form-group">
        ...
        <select name="piksera[compile_assets]" class="form-select" data-width="100%">
    ...
    <div class="form-group">
        ...
        <select name="piksera[force_https]" class="form-select" data-width="100%">
    ...
    <div class="form-group">
        ...
        <select name="piksera[update_channel]" class="form-select" data-width="100%">
    ...
    <div class="form-group">
        ...
        <select name="piksera[developer_mode]" class="form-select" data-width="100%">
