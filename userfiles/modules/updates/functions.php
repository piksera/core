...
//        print '<p style="font-size: 24px; color: #555555;"> ' . _e("Welcome to Piksera", true) . ' '. MW_VERSION . '</p>';
//        print '<p style="font-size: 13px; color: #999999; line-height: 1.6; margin-bottom: 5px;"> ' . _e("Use Piksera to build your website, online shop or blog.") . ' </p>';
