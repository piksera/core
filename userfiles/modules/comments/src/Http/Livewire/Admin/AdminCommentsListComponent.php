<?php
namespace PikseraPackages\Modules\Comments\Http\Livewire\Admin;
...
class AdminCommentsListComponent extends \PikseraPackages\Admin\Http\Livewire\AdminComponent
{
    use WithPagination;
