            ...
            <div class="form-check my-3">
                <div class="d-flex flex-wrap align-items-center">
                    <div class="d-flex col-xl-3 col-md-6 col-12">
                        <livewire:piksera-option::toggle value="y" :optionKey="$socialNetworkOptionKeyEnable" :optionGroup="$moduleId" module="social_links" />
                        <div>
                    ...
                    <div class="col-xl-9 col-md-6 col-12" x-show="$store.socialNetworksEnabled.{{$socialNetworkOptionKeyEnable}} == 1" x-transition>
                        <livewire:piksera-option::text :optionKey="$socialNetworkOptionKeyUrl" :optionGroup="$moduleId" module="social_links" />
                    </div>
                </div>
            </div>
        @endforeach
