...
if (empty($settings)) {
    ...
    $newModuleDefaultSettingsApplied = new \PikseraPackages\Module\ModuleDefaultSettingsApplier();
...
$get_social_links_options = \PikseraPackages\Option\Models\Option::where('option_group', $option_group)->get();
...
$get_website_social_links_options = \PikseraPackages\Option\Models\Option::where('option_group', 'website')->get();
...
$moduleBladeView = 'piksera-module-social-links::' . $module_template;
