...
if (!empty($supportedLanguages)) {
    event_bind('mw.controller.index', function () use ($supportedLanguages) {
        template_head(function () use ($supportedLanguages) {
             ...
             *
                <link rel="canonical" href="https://localhost/piksera/ar_SA/others/apple-computer" />
                <link rel="alternate" href="https://localhost/piksera/bg_BG/others/apple-computer" hreflang="bg-BG" />
                <link rel="alternate" href="https://localhost/piksera/ar_SA/others/apple-computer" hreflang="ar-SA" />
             */
            ...
            if (is_home()) {
                ...
                foreach ($supportedLanguages as $locale) {
                    $pm = new \PikseraPackages\Multilanguage\MultilanguagePermalinkManager($locale['locale']);
