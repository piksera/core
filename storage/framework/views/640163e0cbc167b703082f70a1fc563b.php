...
<?php if(!$quickContentAdd and $content_type): ?>
...
<?php if(user_can_access('module.content.edit')): ?>
    <a  id="js-admin-go-live-edit-main-btn" target="_top"   href="<?php echo e($liveEditUrl); ?>"
       class="mw-admin-go-live-now-btn btn btn-outline-dark mw-admin-bold-outline-dark p-2 mx-1">
...
<?php /**PATH /Users/yahyehassan/Documents/Bloggy/src/PikseraPackages/Content/resources/views/admin/content/topbar-parts/links-right.blade.php ENDPATH**/ ?>