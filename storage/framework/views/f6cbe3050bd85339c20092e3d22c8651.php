...
<head>
    ...
    <?php echo app('Illuminate\Foundation\Vite')('src/PikseraPackages/LiveEdit/resources/js/ui/live-edit-app.js'); ?>

     <?php event_trigger('mw.live_edit.header'); ?>
</head>
<body class="<?php echo e($bodyDarkClass); ?> mw-admin-live-edit-page">
...
<script>
    ...
    window.addEventListener('load', function () {
        if(mw.top() && mw.top().app && mw.top().app.liveEdit && mw.top().app.fontManager){
            mw.top().app.fontManager.addFonts(<?php echo json_encode(\PikseraPackages\Utils\Misc\GoogleFonts::getEnabledFonts()); ?>);
        }
...
<?php print \PikseraPackages\LiveEdit\Facades\LiveEditManager::headTags(); ?>
...
<?php /**PATH /Users/yahyehassan/Documents/Bloggy/src/PikseraPackages/LiveEdit/Providers/../resources/views/iframe.blade.php ENDPATH**/ ?>