            ...
            <div class="card-body px-4 d-flex flex-wrap align-items-center flex-lg-box">
                <div class="col text-center manage-post-item-col-1 d-flex align-items-center" style="max-width: 40px;">
                    ...
                    <div class="custom-control custom-checkbox d-flex align-items-center">
                        <input type="checkbox" value="<?php echo e($content->id); ?>" id="products-<?php echo e($content->id); ?>"  class="js-select-posts-for-action form-check-input" wire:model="checked">
                ...
                <div class="col-auto d-flex align-items-center justify-content-end flex-wrap display-types-content-icons">
                    ...
                    <a class="tblr-body-color" href="<?php echo e(content_link($content->id)); ?>" target="_blank" data-bs-toggle="tooltip" aria-label="View" data-bs-original-title="View">

                        <svg class="me-3" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M440-280H280q-83 0-141.5-58.5T80-480q0-83 58.5-141.5T280-680h160v80H280q-50 0-85 35t-35 85q0 50 35 85t85 35h160v80ZM320-440v-80h320v80H320Zm200 160v-80h160q50 0 85-35t35-85q0-50-35-85t-85-35H520v-80h160q83 0 141.5 58.5T880-480q0 83-58.5 141.5T680-280H520Z"/></svg>
                    </a>

                    <a class="tblr-body-color js-open-in-modal" href="<?php echo e($content->editLink()); ?>" target="_top" data-bs-toggle="tooltip" aria-label="Live edit" data-bs-original-title="Edit">
                    ...
                    <a class="tblr-body-color" href="<?php echo e($content->link()); ?>?editmode=y" target="_top" data-bs-toggle="tooltip" aria-label="Preview" data-bs-original-title="Customize">
                ...
                <div class="col-auto ms-3">
                    <div class="dropdown">
                        <a href="#" class="dropdown-toggle badge <?php if($content->is_active == 1): ?> bg-green-lt <?php else: ?> bg-red-lt <?php endif; ?> form-label mb-0 fs-5 text-decoration-none" data-bs-toggle="dropdown">
                            ...
                            <?php else: ?>
                                ...
                                <?php echo e(_e("Unpublished")); ?>

                            <?php endif; ?>
                        </a>
                        <div class="dropdown-menu">
                            <button type="button" class="dropdown-item" wire:click="publish(<?php echo e($content->id); ?>)">
                                <svg class="mx-1" xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 -960 960 960" width="20"><path d="M378-246 154-470l43-43 181 181 384-384 43 43-427 427Z"/></svg>
                                <?php echo e(_e("Publish")); ?>

                            </button>
                            <button type="button" class="dropdown-item" wire:click="unpublish(<?php echo e($content->id); ?>)">
                ...
                <?php if($content->is_deleted == 1): ?>
                    <div class="col-auto ms-3">
                    <?php echo $__env->make('content::admin.content.livewire.components.trash-buttons-dropdown', ['content'=>$content], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                ...
                <div class="col-1 text-end item-author ms-auto">
                    ...
                    <div class="dropdown content-card-blade-dots-menu-wrapper">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a href="<?php echo e($content->editLink()); ?>" class="dropdown-item ps-4 js-open-in-modal">
                            ...
                            <a href="<?php echo e($content->link()); ?>?editmode=y" target="_top" class="dropdown-item ps-4">
                            ...
                            <?php if(!$content->is_deleted): ?>
                                <a href="javascript:mw.admin.content.delete('<?php echo e($content->id); ?>');" class="dropdown-item ps-4 text-danger js-delete-content-btn-<?php echo e($content->id); ?>">
                            ...
                            <?php endif; ?>
                             ...
                             <?php if($content->is_deleted): ?>
                            <a href="javascript:mw.admin.content.deleteForever('<?php echo e($content->id); ?>');" class="dropdown-item ps-4 text-danger js-delete-content-btn-<?php echo e($content->id); ?>">
                                <svg class="me-1 text-danger" fill="currentColor" xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 0 24 24" width="18px"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M16 9v10H8V9h8m-1.5-6h-5l-1 1H5v2h14V4h-3.5l-1-1zM18 7H6v12c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7z"/></svg>
...
<?php /**PATH /Users/yahyehassan/Documents/Bloggy/src/PikseraPackages/Content/resources/views/admin/content/livewire/display-types/card.blade.php ENDPATH**/ ?>