            ...
            <div class="card-body py-4 row align-items-center flex-lg-box">
                ...
                <div class="col-auto d-flex flex-wrap my-xl-0 my-3">
                    <div class="col-auto d-flex align-items-center justify-content-end flex-wrap display-types-content-icons">
                        <a class="tblr-body-color" href="<?php echo e($content->editLink()); ?>" data-bs-toggle="tooltip" aria-label="Live edit" data-bs-original-title="Edit">
                        ...
                        <a class="tblr-body-color" href="<?php echo e($content->link()); ?>?editmode=y" data-bs-toggle="tooltip" aria-label="Preview" data-bs-original-title="Customize">
...
<?php /**PATH /Users/yahyehassan/Documents/Bloggy/src/PikseraPackages/Product/resources/views/admin/product/livewire/display-types/card.blade.php ENDPATH**/ ?>