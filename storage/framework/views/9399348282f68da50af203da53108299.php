<div>
        ...
        <div class="col-md-2 col-12">
            <div class="form-group">
                <label class="form-label d-block">
                    <?php echo e(_e('Your form lists')); ?>

                </label>
                <select wire:model="filter.formListId" class="form-select form-control">
                    <option><?php echo e(_e('All lists')); ?></option>
                    <?php $__currentLoopData = $formsLists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $formsList): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($formsList->id); ?>"><?php echo e($formsList->title); ?> (<?php echo e($formsList->formsData->count()); ?>)</option>
        ...
        <div class="col-md-4 col-12 ms-lg-auto mt-2">
            <div class="input-icon">
                ...
                <div wire:loading wire:target="filter.keyword" class="spinner-border spinner-border-sm" role="status">
                    <span class="visually-hidden"><?php echo e(_e("Searching")); ?>...</span>
                </div>
            </div>
        </div>

        <div class="col-md-4 col-12 text-xl-end mt-4">
            <button onclick="Livewire.emit('openModal', 'contact-form.settings-modal')" class="btn btn-link tblr-body-color font-weight-bold text-decoration-none me-3 fs-3 mw-admin-action-links" href="<?php echo e(admin_url('settings?group=general')); ?>">
                ...
                <?php echo e(_e('Settings')); ?>

            </button>

            <button onclick="Livewire.emit('openModal', 'contact-form.integrations-modal')" class="btn btn-link tblr-body-color font-weight-bold text-decoration-none fs-3 mw-admin-action-links" href="<?php echo e(admin_url('settings?group=general')); ?>">
    ...
    <div class="mb-2">
        <span><?php echo e($formsData->count()); ?> <?php echo e(_e('items on page. Total')); ?>: <?php echo e($formsData->total()); ?> </span>
    </div>

    <div class="mb-2">
        <small><?php echo e(_e('Entries for list')); ?>: <span><?php echo e(_e('All lists')); ?></span></small>
    </div>

    <div>
        <?php $__currentLoopData = $formsData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $formData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="card shadow-sm mb-4 bg-silver comments-card">
                <div class="card-body d-flex flex-wrap align-items-center justify-content-start gap-5">
                    ...
                    <div class="col-auto d-flex align-items-center gap-1" data-bs-toggle="tooltip" aria-label="#<?php echo e($formData->id); ?>" data-bs-original-title="#<?php echo e($formData->id); ?>">

                        <?php if($formData->is_read == 1): ?>
                            <div>
                        ...
                        <div class="dropdown content-card-blade-dots-menu-wrapper">
                            ...
                            <div class="dropdown-menu">
                                <button class="dropdown-item" wire:click="markAsRead('<?php echo e($formData->id); ?>')">
                                    <?php echo e(_e("Mark as Read")); ?>

                                </button>
                                <button class="dropdown-item" wire:click="markAsUnread('<?php echo e($formData->id); ?>')">
                                    <?php echo e(_e("Mark as Unread")); ?>

                                </button>
                                <button class="dropdown-item" wire:click="delete('<?php echo e($formData->id); ?>')">
                                    <?php echo e(_e("Delete")); ?>
                    ...
                    <div class="col-xl-5">
                        <div class="cursor-pointer" wire:click="preview(<?php echo e($formData->id); ?>)">
                            <?php if($formData->is_read==1): ?>
                                <span class="mb-0 text-muted">
                                    <?php echo e($formData->getSubject()); ?>
                    ...
                    <div class="col">
                        <p class="mb-0">
                            <?php echo e($formData->getFullName()); ?>

                        </p>
                        <span class="text-muted"><?php echo e($formData->getEmail()); ?></span>
                    </div>
                    <div class="col-auto d-flex align-items-center justify-content-end gap-4">
                        <div>
                           <small data-bs-toggle="tooltip" aria-label="<?php echo e($formData->created_at->diffForHumans()); ?>" data-bs-original-title="<?php echo e($formData->created_at->diffForHumans()); ?>">
                                <?php echo e($formData->created_at->format('M d, Y')); ?>

                              <br/>
                               <small> <?php echo e($formData->created_at->format('h:i A')); ?></small>
                           </small>
                        </div>
                    </div>
                    <div class="col-auto">
                        <button class="btn btn-link tblr-body-color" data-bs-toggle="tooltip" aria-label="<?php echo e('View'); ?>" data-bs-original-title="<?php echo e('View'); ?>"
                                wire:click="preview(<?php echo e($formData->id); ?>)">
        ...
        <?php if($formsData->count() == 0): ?>
            <div class="mt-2">
                <div class="alert alert-info">
                    <?php echo e(_e('No data found')); ?>
    ...
    <div class="row p-0">
        <div class="col-sm-3">
            <div class="export-label" wire:click="exportDataExcel">
                <span><?php echo e(_e('Export data')); ?></span>
                <span class="btn btn-outline-dark btn-sm"><?php echo e(_e('Excel')); ?></span>
            </div>
        </div>
        ...
        <div class="col-sm-2 text-center text-sm-right">
            <div class="form-group">
                <form method="get">
                    <small><?php echo e(_e('Show items per page')); ?></small>
...
<?php /**PATH /Users/yahyehassan/Documents/Bloggy/userfiles/modules/contact_form/src/resources/views/livewire//admin/contact-form/list.blade.php ENDPATH**/ ?>