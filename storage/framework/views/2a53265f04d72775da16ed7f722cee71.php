        ...
        <div>
            <div class="d-flex justify-content-between mb-3">
                ...
                <label class="form-label font-weight-bold">
                    <?php echo e(__('Your fields')); ?>

                </label>
                <small class="d-block mb-2 text-muted">
                    <?php echo e(__('List of your added custom fields')); ?>

                </small>
                </div>
                <div class="d-flex align-items-center">
                    <button type="button" onclick="Livewire.emit('openMwTopDialogIframe', 'custom-field-add-modal', <?php echo e(json_encode(['relId'=>$relId,'relType'=>$relType])); ?>)" class="d-flex align-items-center btn btn-outline-dark js-add-custom-field">
            ...
            <div class="table-responsive">
                <div class="mw-responsive-table-wrapper">
                    <table class="table card-table table-vcenter mw-mobile-table" style="min-width: 270px;">
                        ...
                        <tbody id="js-sortable-items-holder-<?php echo e($this->id); ?>">

                        <?php if($customFields->count() == 0): ?>
                            <tr>
                                <td colspan="6">
                                    <?php echo e(__('No custom fields added')); ?>
                        ...
                        <tr class="js-sortable-item" sort-key="<?php echo e($customField->id); ?>" ondblclick="Livewire.emit('openMwTopDialogIframe', 'custom-field-edit-modal', <?php echo e(json_encode(['customFieldId'=>$customField->id])); ?>)">
                            <td>
                            ...
                            <td class="custom-field-icon">
                                <div>
                                    <span class="mw-custom-field-icon-<?php echo e($customField->type); ?>"></span>
                                </div>
                            </td>
                            ...
                            <td>
                                <div>
                                    <?php echo e($customField->fieldValueText()); ?>

                                </div>
                            </td>

                            <td class="text-center">
                                <button class="mw-liveedit-button-actions-component" onclick="Livewire.emit('openMwTopDialogIframe', 'custom-field-edit-modal', <?php echo e(json_encode(['customFieldId'=>$customField->id])); ?>)" type="button">
                            ...
                            <td class="text-center">
                                ...
                                ?>
                                <button onclick="Livewire.emit('openModal', 'admin-confirm-modal', <?php echo e(json_encode($deleteModalData)); ?>)" type="button" class="mw-liveedit-button-actions-component" data-bs-toggle="tooltip" aria-label="Delete" data-bs-original-title="Delete">
        ...
        <div wire:ignore>
            <script>
                window.mw.items_editor_sort = function () {
                    ...
                    if (!mw.$("#js-sortable-items-holder-<?php echo e($this->id); ?>").hasClass("ui-sortable")) {
                        mw.$("#js-sortable-items-holder-<?php echo e($this->id); ?>").sortable({
                            ...
                            update: function () {
                                setTimeout(function () {
                                    var obj = {itemIds: []};
                                    var sortableItems = document.querySelectorAll('#js-sortable-items-holder-<?php echo e($this->id); ?> .js-sortable-item');
...
<?php /**PATH /Users/yahyehassan/Documents/Bloggy/src/PikseraPackages/CustomField/resources/views//livewire/custom-fields-list-component.blade.php ENDPATH**/ ?>