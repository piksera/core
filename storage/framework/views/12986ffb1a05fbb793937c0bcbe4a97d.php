<div>
    ...
    <?php if($multipleMoveToCategoryShowModal): ?>
    ...
    <?php if($multiplePublishShowModal): ?>
        <script>
    ...
    <?php if($multipleUnpublishShowModal): ?>
        <script>
    ...
    <?php if($multipleDeleteShowModal): ?>
        <script>
    ...
    <?php if($multipleUndeleteShowModal): ?>
        <script>
    ...
    <?php if($multipleDeleteForeverShowModal): ?>
        <script>
...
<?php /**PATH /Users/yahyehassan/Documents/Bloggy/src/PikseraPackages/Content/resources/views/admin/content/livewire/content-bulk-options.blade.php ENDPATH**/ ?>