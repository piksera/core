...
<ul class="navbar-nav-padding nav-item-profile-wrapper">
    ...
    <li class="mt-3">
            ...
            <?php echo $__env->make('admin::layouts.partials.navabar-bottom-menu-lang-switch', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <li class="nav-item nav-item-profile pt-1">
        ...
        <a href="<?php echo e(admin_url('user/profile')); ?>" class="nav-link fs-3">

        <?php if(user_has_picture(user_id())): ?>
        <img src="<?php echo e(user_picture(user_id(),165,165)); ?>" alt="" class="rounded-circle profile-img" >
        <?php else: ?>
        <div class="mw-admin-sidebar-profile">
            <span class="mb-0 text-uppercase" style="font-size: 14px; text-overflow: ellipsis; overflow: hidden; display: block; white-space:nowrap; max-width: 150px;">
...
<?php /**PATH /Users/yahyehassan/Documents/Bloggy/src/PikseraPackages/Admin/Providers/../resources/views/layouts/partials/navbar-bottom-menu.blade.php ENDPATH**/ ?>