<?php $__env->startSection('content'); ?>
    ...
    <div id="settings-container">
       ...
       // $moduleTypeForLegacyModule = $moduleTypeForLegacyModule.'/admin';
        ...
        $livewireComponentName = 'piksera-module-'.$moduleTypeForComponent.'::settings';
        $livewireComponentDashed = 'piksera-module-'.$moduleTypeForComponentDashed.'::settings';




        $moduleSettingsRegisteredAlias =  \PikseraPackages\Module\Facades\ModuleAdmin::getSettings($moduleType);
...
//        try {
//            $output = \Livewire\Livewire::mount('piksera-live-edit::' . $moduleTypeForComponent, [
//                //'id' => $moduleId,
//                'moduleId' => $moduleId,
...
//        }
        ...
        <?php if(livewire_component_exists($livewireComponentName)): ?>
                <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount($livewireComponentName, [
                    'moduleId' => $moduleId,
                    'moduleType' => $moduleFolder,
                    'moduleParams' => $params,
                ])->html();
} elseif ($_instance->childHasBeenRendered('module-settings-'.$moduleId)) {
    $componentId = $_instance->getRenderedChildComponentId('module-settings-'.$moduleId);
    $componentTag = $_instance->getRenderedChildComponentTagName('module-settings-'.$moduleId);
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('module-settings-'.$moduleId);
} else {
    $response = \Livewire\Livewire::mount($livewireComponentName, [
                    'moduleId' => $moduleId,
                    'moduleType' => $moduleFolder,
                    'moduleParams' => $params,
                ]);
    $html = $response->html();
    $_instance->logRenderedChild('module-settings-'.$moduleId, $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <?php elseif(livewire_component_exists($livewireComponentDashed)): ?>
                <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount($livewireComponentDashed, [
                    'moduleId' => $moduleId,
                    'moduleType' => $moduleFolder,
                    'moduleParams' => $params,
                ])->html();
    ...
    $response = \Livewire\Livewire::mount($livewireComponentDashed, [
                    'moduleId' => $moduleId,
                    'moduleType' => $moduleFolder,
                    'moduleParams' => $params,
                ]);
...
?>
        <?php else: ?>
            ...
            <?php if(is_module($moduleTypeForLegacyModule)): ?>
...
<?php echo $__env->make('admin::layouts.iframe', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yahyehassan/Documents/Bloggy/src/PikseraPackages/LiveEdit/Providers/../resources/views/module-settings.blade.php ENDPATH**/ ?>