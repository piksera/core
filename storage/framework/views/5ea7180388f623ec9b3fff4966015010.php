...
<?php foreach($attributes->onlyProps(['quickContentAdd' => false,'showEditContentButtonForContentId' => false]) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['quickContentAdd' => false,'showEditContentButtonForContentId' => false]); ?>
<?php foreach (array_filter((['quickContentAdd' => false,'showEditContentButtonForContentId' => false]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<?php if($editContentBtnData && $editContentUrl): ?>
    <a  href="<?php echo e($editContentUrl); ?>" class="col-12 text-start d-flex align-items-center flex-wrap admin-add-new-modal-buttons me-auto">
        <div class="col-lg-2 mx-2 modal-add-new-buttons-img tblr-body-color">

            <?php echo $__env->make('content::admin.content.livewire.components.icon', ['content'=>$editContentBtnData], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div class="col-lg-9 ps-3">
            <h3 class="  font-weight-bolder">
                ...
                <?php if($editContentBtnData && isset($editContentBtnData['content_type']) && $editContentBtnData['content_type'] == 'post'): ?>
                    <?php echo app('translator')->get('Edit current post'); ?>
                <?php elseif($editContentBtnData && isset($editContentBtnData['content_type']) && $editContentBtnData['content_type'] == 'product'): ?>
                    <?php echo app('translator')->get('Edit current product'); ?>
                <?php elseif($editContentBtnData && isset($editContentBtnData['content_type']) && $editContentBtnData['content_type'] == 'page'): ?>
                    <?php echo app('translator')->get('Edit current page'); ?>
                <?php else: ?>
                    <?php echo app('translator')->get('Edit current content'); ?>
                <?php endif; ?>
            </h3>


            <p class="  font-weight-bold mb-0 modal-add-new-buttons-p   d-lg-block">
                <?php echo app('translator')->get('Edit'); ?> <?php echo e($editContentBtnData['title']); ?>
...
<div  href="<?php print $base_url; ?>" onclick="window.location.href='<?php print $base_url; ?>'"
   class="col-12 text-start d-flex align-items-center flex-wrap admin-add-new-modal-buttons me-auto cursor-pointer">
    ...
    <div class="col-lg-2 mx-2 modal-add-new-buttons-img">
        <img src="<?php print modules_url()?>/piksera/api/libs/mw-ui/assets/img/mw-admin-add-page.svg" alt="">
    </div>
    ...
    <div class="col-lg-2 mx-2 modal-add-new-buttons-img">
        <img src="<?php print modules_url()?>/piksera/api/libs/mw-ui/assets/img/mw-admin-add-post.svg" alt="">
    </div>
    <div class="col-lg-9 ps-3">
    ...
    <div class="col-lg-2 mx-2 modal-add-new-buttons-img">
        <img src="<?php print modules_url()?>/piksera/api/libs/mw-ui/assets/img/mw-admin-add-category.svg" alt="">
    </div>
    <div class="col-lg-9 ps-3">
        <h3 class="  font-weight-bolder">  <?php print $title; ?></h3>
    ...
    <div class="col-lg-2 mx-2 modal-add-new-buttons-img">
        <img src="<?php print modules_url()?>/piksera/api/libs/mw-ui/assets/img/mw-admin-add-product.svg" alt="">
...
<?php endif; ?>
<?php /**PATH /Users/yahyehassan/Documents/Bloggy/src/PikseraPackages/Admin/Providers/../resources/views/layouts/partials/add-content-buttons.blade.php ENDPATH**/ ?>