<div class="dropdown content-card-blade-dots-menu-wrapper">
    ...
    <div class="dropdown-menu">
        ...
        <?php if($content->is_active < 1): ?>
            <a href="javascript:mw.admin.content.publishContent('<?php echo e($content->id); ?>');" class="dropdown-item ps-4 mw-set-content-unpublish badge badge-warning font-weight-normal"><?php _e("Unpublished") ?></a>
...
?>
<?php /**PATH /Users/yahyehassan/Documents/Bloggy/src/PikseraPackages/Content/resources/views/admin/content/livewire/components/manage-links.blade.php ENDPATH**/ ?>