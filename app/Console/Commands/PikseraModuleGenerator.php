...
class PikseraModuleGenerator extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'piksera-module-generator';
    ...
    public function handle()
    {
        ...
        $this->info('Piksera Module Generator v0.1');
        $this->info('- - - - - - - - - - -');
        ...
        $moduleNamespace = 'PikseraPackages\\Modules\\' . Str::ucfirst($moduleNameNoSpaces);
        ...
        $moduleStubPath = (dirname(dirname(__DIR__))) . DS . 'stubs' . DS . 'piksera-module';
